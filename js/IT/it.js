...
$(document).ready(function () {
	...
	$('#window-title').text('Inventory Transfer');
    ...
    //Initialize Title
    $('#mod-title').text('Inventory Transfer');
    //End Initialize Title


    //Load Grpo Series 
    $('#btnSeries').html('Loading...')
    $('#SeriesList').load('../../proc/views/IT/vw_series.php?objtype=67', function () {
	...
	$('select[name=txtSalesEmployee]').load('../../proc/views/IT/vw_salesemployee.php');
	
	$('select[name=txtPayment]').html('<option>Loading...</option>');
	$('select[name=txtPayment]').load('../../proc/views/IT/vw_paymentterms.php');
	
	$('select[name=txtPriceList]').html('<option>Loading...</option>');
	$('select[name=txtPriceList]').load('../../proc/views/IT/vw_pricelist.php');
...
//        $('input[name=txtDocNo]').val($(this).attr('val-nextnum'));
    ...
    $(document.body).on('change', 'select[name=cmbServiceType]', function () {
        ...
        $('#ModDetails').load('../../forms/IT/IT-details.php', function () {
    ...
    $(document.body).on('click', '#btnAddRow', function () {
        ...
        //End row number
        $(this).load('../../forms/IT/IT-details-row.php?servicetype=I', function (result) {
    ...
    $(document.body).on('click', '#btnFreeText', function () {
        ...
        var rowno = 0;
        rowno = ($('#tblDetails tbody tr:last').find('td.rowno').text() == '') ? 1 : parseFloat($('#tblDetails tbody tr:last').find('td.rowno').text()) + 1;
        $(this).load('../../forms/IT/IT-details-row.php?servicetype=I&freetext=1', function (result) {
    ...
    $('#ItemModal').on('shown.bs.modal', function () 
	{
        ...
        $('#ItemCont').load('../../proc/views/IT/vw_itemlist.php?whscode=' + whscode, function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/IT/vw_itemlist-load.php?whscode=' + encodeURI(whscode),
                                data: {
                                    itemcode: itemcode
                                },
    ...
    $(document.body).on('keyup', 'input[name=ItemSearch]', function () 
	{
        ...
        $('#ItemCont table tbody').load('../../proc/views/IT/vw_itemlist-load.php?srchval=' + encodeURI(searchVal) + '&whscode=' + encodeURI(whscode) );
    });
    //End Search Item
    ...
    $('#WhsModal').on('shown.bs.modal', function () 
	{
        if (activewhs != '')
        {
            if ($('input[name=' + activewhs + ']').prop('disabled') == true
                    || $('input[name=' + activewhs + ']').attr('readonly'))
            {
                $('#WhsModal').modal('hide');
                return;
            }
        ...
        $('#WhsCont').load('../../proc/views/IT/vw_whslist.php', function () {
...
//            }
    ...
    $(document.body).on('keyup', 'input[name=WhsSearch]', function () {
        ...
        $('#WhsCont table tbody').load('../../proc/views/IT/vw_whslist-load.php?srchval=' + encodeURI(searchVal) );
    })
    //End Search Whs
    ...
    $(document.body).on('keyup', '.weightlive', function () {
        ...
        if (itemcode.substr(0, 9) === 'LIVE_HOGS')
        {
            ...
            $.ajax({
                type: 'GET',
                url: '../../proc/views/IT/vw_priceperkg.php',
    ...
    $('#AcctModal').on('shown.bs.modal', function () {
        ...
        $('#AcctCont').load('../../proc/views/IT/vw_acctlist.php', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/IT/vw_acctlist-load.php',
    ...
    $(document.body).on('keyup', 'input[name=AcctSearch]', function () {
        ...
        $('#AcctCont table tbody').load('../../proc/views/IT/vw_acctlist-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Acct
    ...
    $('#InvDataModal').on('shown.bs.modal', function () {
        ...
        if (itemcode != '') {
            ...
            $('#InvDataCont').load('../../proc/views/IT/vw_invdatalist.php?itemcode=' + itemcode , function () {
    ...
    $('#DocumentModal').on('shown.bs.modal', function () {
        ...
        $('#DocumentCont').load('../../proc/views/IT/vw_doclist.php', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/IT/vw_doclist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
    ...
    $(document.body).on('keyup', 'input[name=DocumentSearch]', function () {
        ...
        $('#DocumentCont table tbody').load('../../proc/views/IT/vw_doclist-load.php?srchval=' + encodeURI(searchVal) );
    })
    //End Search Document
    ...
    $(document.body).on('keyup', 'input[name=txtDocEntry]', function () {
        ...
        $.getJSON('../../proc/views/IT/vw_getdocumentdata.php?docentry=' + docentry , function (data) {
            ...
            $.each(data, function (key, val) {
                ...
                if (val.DocStatus == 'C') 
				{
                    ...
                    $('select[name=txtPriceList]').html('<option>Loading...</option>');
                    $('select[name=txtPriceList]').load('../../proc/views/IT/vw_pricelist.php', function () {
						$('select[name=txtPriceList]').val(val.GroupNum).prop('disabled', true);
                    });
                    
					$('select[name=txtSalesEmployee]').html('<option>Loading...</option>');
                    $('select[name=txtSalesEmployee]').load('../../proc/views/IT/vw_salesemployee.php', function () {
						$('select[name=txtSalesEmployee]').val(val.SlpCode).prop('disabled', true);
                    });

					$('input[name=txtPickAndPackRemarks]').val(val.PickRmrk).prop('disabled', true);
    ...
    $('#BPModal').on('shown.bs.modal', function () {
        ...
        $('#BPCont').load('../../proc/views/IT/vw_bplist.php?CardType=S', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/IT/vw_bplist-load.php',
                                data: {
									itemcode : itemcode
								},
								success: function (html) {
    ...
    $(document.body).on('keyup', 'input[name=BPSearch]', function () {
        ...
        $('#BPCont table tbody').load('../../proc/views/IT/vw_bplist-load.php?srchval=' + encodeURI(searchVal) );
    })
    //End Search BP
    ...
    $(document.body).on('keyup', 'input[name=txtBaseEntry]', function () {
        ...
        if (basentry != '') {
            //Show Base Document
            //Get PR data using JSON
            $.getJSON('../../proc/views/IT/vw_getitrdata.php?docentry=' + basentry , function (data) {
                /* data will hold the php array as a javascript object */
                ...
                $.each(data, function (key, val) {
                    ...
                    if (val.DocStatus == 'C') {
                        ...
                        $('input[name=txtJournalRemarks]').val(val.JrnlMemo).prop('disabled', true);
                        $('textarea[name=txtRemarksF]').val(val.Comments + ' Based on Inventory Transfer Request ' + val.DocNum).prop('disabled', true);
                        ...
                        $('textarea[name=txtRemarksF]').val(val.Comments + ' Based on Inventory Transfer Request ' + val.DocNum).prop('disabled', false);
                ...
                setTimeout(function () {
                    $('#modal-load-init').modal('hide');
                    $('#modal-load-init').modal('show');
                    populatedetITR(basentry, function () {
                        $('input[name=TotBefDisc]').trigger('keyup')
                        $('#modal-load-init').modal('hide');
    ...
    //Load PR Documents
    $('#ITRModal').on('shown.bs.modal', function () {
		
        $('#ITRCont').html('<p class="text-center"><img src=../../img/ajax-loader.gif /> Loading...</p>');
        $('#ITRCont').load('../../proc/views/IT/vw_itrdoclist.php', function () {
            //Add Scroll Function 
            $('#ITRCont .table-responsive').bind('scroll', function () {
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        var itemcode = $('#ITRCont table tbody > tr:last').children('td').eq(0).text();
                        var ctr = 0;
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/IT/vw_itrdoclist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {

                                    $('#ITRCont table tbody').append(html);
                                    $('#itm-loader').each(function () {
                                        $(this).remove();
                                    });
        ...
        $('input[name=ITRSearch]').focus();
    })
    //End Load PR Documents
    
    
    //Search Document
    $(document.body).on('keyup', 'input[name=ITRSearch]', function () {
        var searchVal = $(this).val().toLowerCase();
		
        $('#ITRCont table tbody').html('<tr><td class="text-center" colspan="7"><p><img src=../../img/ajax-loader.gif /></p></td></tr>');
        $('#ITRCont table tbody').load('../../proc/views/IT/vw_itrdoclist-load.php?srchval=' + encodeURI(searchVal) );
    })
    //End Search Document

    //Clear PR Document List
    $('#ITRModal').on('hide.bs.modal', function () {
        $('#ITRCont').empty();
    ...
    $('#ITRModal').keydown(function (e) {
        switch (e.which) {
            ...
            case 40: // down
                ...
                //Check if selected
                if ($('#tblITRDocument tbody').find('tr.selected-whs').index() >= 0) {
                    $('tr.selected-whs').next().trigger('click');

                    //$('#WhsCont > .table-responsive').scrollTop(10);
                } else {
                    $('#tblITRDocument tbody > tr:first').trigger('click');
                }
                //End
                break;
    ...
    $(document.body).on('dblclick', '#tblITRDocument tbody > tr', function () {
		...
		//window.open("../PO/PO.php?BaseEntry=" + docentry + '&CompanyDb=' + encodeURI(CompanyDb), "", "width=1130,height=550,left=220,top=110");
    ...
    $(document.body).on('click', '#btnChoose', function () {
        ...
        setTimeout(function () {
            $('#modal-load-init').modal('hide');
            $('#modal-load-init').modal('show');
            populatedetITRMulti(docentry, function () {
                //$('input[name=TotBefDisc]').trigger('keyup');
                isSingleITR = false;
    ...
    $(document.body).on('keyup', 'input[name=ITRSearch]', function () {
        ...
        //Search multiple
        var $rows = $('#ITRCont table tbody tr');
        //$('#ITRCont').prepend('<p class="text-center" id="itm-loader"><img src=../../img/ajax-loader.gif /> Searching...</p>');
    ...
    $(document.body).on('click', '#tblITRDocument tbody > tr', function (e) {


        highlightmultiple('#tblITRDocument', this);
    ...
    $(document.body).on('click', '#btnPrint', function () {
        ...
        if (docentry != '') {
            ...
            window.open("../../report/IT/it-report.php?docentry=" + encodeURI(docentry) , "", "width=1130,height=550,left=220,top=110");
        }
    })
    //End Print Document
	
	$(document.body).on('click','#btnCancelDoc',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/it/exec-cancel.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
					...
					if(res[0] == 'true'){
						...
						disablebuttons(true)
						setTimeout(function(){
							location.replace('../../forms/it/it.php');
						},2000)
    ...
    //End Canceled SO
		...
		$(document.body).on('click','#btnITListVIEW',function(e)
	{
		$('#resView').empty();
	...
	$(document.body).on('click','#btnITListPDF',function(e)
	{
    	var err = 0;
    	var errmsg = '';
    	var txtDateFrom = $('input[name=txtDateFrom]').val();
		...
		if(err == 0)
		{
			window.open("../../report/it/itlist-report.php?txtRefListFrom=" + encodeURI(txtRefListFrom) + "&txtRefListTo=" + encodeURI(txtRefListTo) + "&txtDateFrom=" + encodeURI(txtDateFrom) + "&txtDateTo=" + encodeURI(txtDateTo), "", "width=1130,height=550,left=220,top=110");
		}
		else
		{
	...
	$(document.body).on('click','#btnITListEXCEL',function(e)
	{
    	var err = 0;
    	var errmsg = '';
    	var txtDateFrom = $('input[name=txtDateFrom]').val();
		...
		if(err == 0)
		{
			window.open("../../report/it/itlist-excel.php?txtRefListFrom=" + encodeURI(txtRefListFrom) + "&txtRefListTo=" + encodeURI(txtRefListTo) + "&txtDateFrom=" + encodeURI(txtDateFrom) + "&txtDateTo=" + encodeURI(txtDateTo), "", "width=1130,height=550,left=220,top=110");
		}
		else
		{
			notie.alert(3, errmsg, 2);
...
// var pickandpackremarks = $('input[name=txtPickAndPackRemarks]').val();
        ...
        var tbl2 = $('#tblDetails tbody tr').each(function (i) {
            ...
            // itArr.push('"' + $(this).find('select.branchesoutlets').val() + '"');
            // itArr.push('"' + $(this).find('select.truckplatenumber').val() + '"');
            itArr.push('"' + $(this).find('input.lineno').val() + '"');
			itArr.push('"' + $(this).find('input.serialno').val() + '"');


            //});
            if (isSingleITR == false) {
        ...
        if (isSingleITR) {
            urlstr = '../../proc/exec/IT/exec-saveit.php';
        } else {
            urlstr = '../../proc/exec/IT/exec-saveit-multi.php';
        }
        ...
        if (err == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: '../../proc/exec/IT/exec-saveit.php',
                data: {
                    json: json.replace(/(\r\n|\n|\r)/gm, '[newline]'),
                    basentry: basentry,
                    bpcode: bpcode,
...
//            itArr.push('"' + $(this).find('input.barcode').val() + '"');
        ...
        if (err == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: '../../proc/exec/IT/exec-updateit.php',
                data: {
                    json: json.replace(/(\r\n|\n|\r)/gm, '[newline]'),
                    basentry: basentry,
                    bpcode: bpcode,
...
//                    alert(html);
    ...
    function checkitemcode(itemcode) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/IT/vw_checkitemcode.php',
            async: false,
            data: {
				itemcode : itemcode
			},
    ...
    function checkwhs(whscode) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/IT/vw_checkwhscode.php',
            async: false,
            data: {
				whscode : whscode
			}, 
    ...
    function checkacctcode(acctcode) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/IT/vw_checkacctcode.php',
            async: false,
            data: {
				acctcode : acctcode
			}, 
    ...
    function checkbpcode(bpcode) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/IT/vw_checkbpcode.php',
            async: false,
            data: {
				bpcode : bpcode
			}, 
...
//        discount = !$.isNumeric(discount.replace(/,/g, '')) ? 0 : parseFloat(discount.replace(/,/g, ''));
    ...
    function populatedet(docentry, callback) {
        ...
        $('#tblDetails tbody').load('../../proc/views/IT/vw_documentdetailsdata.php?docentry=' + docentry , function (result) {
    ...
    function populatedetITR(docentry, callback) {


        $('#tblDetails tbody').load('../../proc/views/IT/vw_itrdetailsdata.php?docentry=' + docentry , function (result) {
    ...
    //Populate PO with PR Data Details
    function populatedetITRMulti(docentry, callback) {


        $('#tblDetails tbody').load('../../proc/views/IT/vw_itrdetailsdata-multi.php?docentry=' + encodeURI(docentry) , function (result) {

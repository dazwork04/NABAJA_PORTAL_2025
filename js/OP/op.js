...
$('#window-title').text('Disbursement');
...
//Intialize Modal
	...
	$('#window-title').text('Disbursements');
    //Initialize Title
    $('#mod-title').text('Disbursements');
    ...
    $('#SeriesList').load('../../proc/views/OP/vw_series.php?objtype=46', function () {
	...
	$('select[name=selPaymentMethod]').load('../../proc/views/OP/vw_paymentmethod.php');
	
	$('select[name=selCreditCardName]').html('<option>Loading...</option>');
	$('select[name=selCreditCardName]').load('../../proc/views/OP/vw_creditcardname.php');
	
	$('select[name=txtCountry]').html('<option>Loading...</option>');
	$('select[name=txtCountry]').load('../../proc/views/OP/vw_countries.php?countrycode=', function () 
	{
	...
	$('select[name=txtSalesEmployee]').load('../../proc/views/OP/vw_salesemployee.php');
	
	$('select[name=txtPayment]').html('<option>Loading...</option>');
	$('select[name=txtPayment]').load('../../proc/views/OP/vw_paymentterms.php');
	...
	$(document.body).on('change','input[name=radCategory]',function()
	{
		...
		if(radCategory == 'Account')
		{
			...
			$('#ModDetails').load('../../forms/OP/OP-details1.php',function()
			{
				$('#tblDetails tbody tr:last').find('select.taxgroup').html('<option>Loading...</option>');
				$('#tblDetails tbody tr:last').find('select.taxgroup').load('../../proc/views/OP/vw_taxgroup.php');
			});
		...
		{
			$('#ModDetails').html('<p class="text-center"><img src=../../img/ajax-loader.gif /></p>');
			$('#ModDetails').load('../../forms/OP/OP-details.php');
	...
	$(document.body).on('change','select[name=selCreditCardName]',function(){
		...
		$('input[name=txtGLAccountCreditCard]').load('../../proc/views/OP/vw_creditcardglaccount.php?creditcard=' + CreditCard , function (data) 
		{
    ...
    $(document.body).on('change', '#txtCountry', function () {
        ...
        $('select[name=txtBankName]').load('../../proc/views/OP/vw_banks.php?countrycode=' + selectedcountry , function () {
    ...
    $(document.body).on('change', '#txtBankName', function () {
        ...
        $('select[name=txtBranch]').load('../../proc/views/OP/vw_bankbranches.php?countrycode=' + selectedcountry
    ...
    function loadDetails() 
	{
        ...
        $('#ModDetails').html('<p class="text-center"><img src=../../img/ajax-loader.gif /></p>');
        $('#ModDetails').load('../../forms/OP/OP-details.php', function () {
    ...
    $(document.body).on('click', '#btnAddRow', function () 
	{
        ...
        $(this).load('../../forms/OP/OP-details-row.php', function (result) 
		{
    ...
    $('#ItemModal').on('shown.bs.modal', function () {
        ...
        $('#ItemCont').load('../../proc/views/OP/vw_itemlist.php', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/OP/vw_itemlist-load.php',
    ...
    $(document.body).on('keyup', 'input[name=ItemSearch]', function () {
        ...
        $('#ItemCont table tbody').load('../../proc/views/OP/vw_itemlist-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Item
    ...
    $('#WhsModal').on('shown.bs.modal', function () {
        ...
        $('#WhsCont').load('../../proc/views/OP/vw_whslist.php', function () {
    ...
    $(document.body).on('keyup', 'input[name=WhsSearch]', function () {
        ...
        $('#WhsCont table tbody').load('../../proc/views/OP/vw_whslist-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Whs
    ...
    $('#BarcodeModal').on('shown.bs.modal', function () {
        ...
        $('#BarcodeCont').load('../../proc/views/OP/vw_barcodelist.php', 'itemcode=' + detitemcode, function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'GET',
                                url: '../../proc/views/OP/vw_barcodelist-load.php',
...
//Clear Barcode
	...
	$('#DepartmentModal').on('shown.bs.modal',function()
	{
		...
		$('#DepartmentCont').load('../../proc/views/OP/vw_deptlist.php');
	...
	$(document.body).on('keyup','input[name=DepartmentSearch]',function(){
        ...
        $('#DepartmentCont table tbody').load('../../proc/views/OP/vw_deptlist-load.php?srchval=' + encodeURI(searchVal));
	})
	...
	$('#ProjectModal').on('shown.bs.modal',function()
	{
		...
		$('#ProjectCont').load('../../proc/views/OP/vw_projlist.php');
	...
	$(document.body).on('keyup','input[name=ProjectSearch]',function()
	{
        ...
        $('#ProjectCont table tbody').load('../../proc/views/OP/vw_projlist-load.php?srchval=' + encodeURI(searchVal));
	});
	//End Search Department
	...
	$('#EmployeeModal').on('shown.bs.modal',function()
	{
		...
		$('#EmployeeCont').load('../../proc/views/OP/vw_emplist.php');
	...
	$(document.body).on('keyup','input[name=EmployeeSearch]',function()
	{
        ...
        $('#EmployeeCont table tbody').load('../../proc/views/OP/vw_emplist-load.php?srchval=' + encodeURI(searchVal));
	});
	//End Search Employee
	...
	$('#EquipmentModal').on('shown.bs.modal',function()
	{
		...
		$('#EquipmentCont').load('../../proc/views/OP/vw_equiplist.php');
	...
	$(document.body).on('keyup','input[name=EquipmentSearch]',function(){
		...
		$('#EquipmentCont table tbody').load('../../proc/views/OP/vw_equiplist-load.php?srchval=' + encodeURI(searchVal));
	})
	...
	$('#AcctModal').on('shown.bs.modal',function()
	{
		...
		$('#AcctCont').load('../../proc/views/OP/vw_acctlist.php',function()
		{
				...
				if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight)
				{
					if($(this).scrollTop() > 0)
					{
						...
						if(ctr == 0)
						{
							...
							$.ajax({
								type: 'POST',
								url: '../../proc/views/OP/vw_acctlist-load.php',
								data: 
								{
									itemcode : itemcode
								},
	...
	$(document.body).on('keyup','input[name=AcctSearch]',function()
	{
        ...
        $('#AcctCont table tbody').load('../../proc/views/OP/vw_acctlist-load.php?srchval=' + encodeURI(searchVal));
	});
	//End Search Acct
    ...
    $('#DocumentModal').on('shown.bs.modal', function () {
        ...
        $('#DocumentCont').load('../../proc/views/OP/vw_doclist.php', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/OP/vw_doclist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
    ...
    $(document.body).on('keyup', 'input[name=DocumentSearch]', function () {
        ...
        $('#DocumentCont table tbody').load('../../proc/views/OP/vw_doclist-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Document
    ...
    $(document.body).on('keyup', 'input[name=txtDocEntry]', function () 
	{
        ...
        $.getJSON('../../proc/views/OP/vw_getdocumentdata.php?docentry=' + docentry , function (data) 
		{
			var ctr = 0;
            $('#modal-load-init').modal('show');
				$.each(data, function (key, val) 
				{
					...
					$('input[name=txtRemitTo]').val(val.U_RemitTo).prop('disabled', true);
					...
					if(val.CheckSum != 0 && val.CheckSum != '')	
                    {
						...
						$('select[name=txtCountry]').html('<option>Loading...</option>');
						$('select[name=txtCountry]').load('../../proc/views/OP/vw_countries.php?countrycode=' + val.CountryCod , function () {

						});
						$('select[name=txtCountry]').prop('disabled', true);

						$('select[name=txtBankName]').html('<option>Loading...</option>');
						$('select[name=txtBankName]').load('../../proc/views/OP/vw_banks.php?countrycode=' + selectedcountry
								+ '&bankcode=' + selectedbankcode
						...
						$('select[name=txtBranch]').html('<option>Loading...</option>');
						$('select[name=txtBranch]').load('../../proc/views/OP/vw_bankbranches1.php?countrycode=' + selectedcountry
						+ '&bankcode=' + selectedbankcode
						+ '&customercode=' + selectedcustomer
						+ '&branch=', function () 
						{
							$('select[name=txtBranch]').val(val.Branch + ' - ' + val.AcctNum);
						});
    ...
    $('#BPModal').on('shown.bs.modal', function () {
        ...
        $('#BPCont').load('../../proc/views/OP/vw_bplist.php?CardType=S', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/OP/vw_bplist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
    ...
    $(document.body).on('dblclick', '#tblBP tbody > tr', function () {
		...
		$('select[name=selContactPerson]').load('../../proc/views/OP/vw_contactlist.php?cardcode=' + BPCode );
		
        //Load Bill To
		$('textarea[name=txtBillTo]').html('Loading...');
		$('textarea[name=txtBillTo]').load('../../proc/views/OP/vw_billto.php?cardcode=' + BPCode );
        ...
        //populateARList(BPCode, function () {    });

        $('input[name=txtJournalRemarks]').val('Disbursement - ' + BPCode);
    })
    //End Select Acct Table Row Click
    ...
    $(document.body).on('keyup', 'input[name=BPSearch]', function () {
        ...
        $('#BPCont table tbody').load('../../proc/views/OP/vw_bplist-load.php?srchval=' + encodeURI(searchVal) );
    });
    ...
    $(document.body).on('blur', 'input[name=txtCustomer]', function () 
	{
		...
		if(radCategory == 'Vendor')
		{
			...
			$('input[name=txtJournalRemarks]').val('Incoming Payments - ' + BPCode);
		}
    })
    //End BP Code Bind
    ...
    $('#CashModal').on('shown.bs.modal', function () 
	{
        ...
        $('#CashCont').load('../../proc/views/OP/vw_cash.php', function () {
        });
    ...
    $(document.body).on('keyup', 'input[name=CashSearch]', function () {
        ...
        $('#CashCont table tbody').load('../../proc/views/OP/vw_Cashlist-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Cash
    ...
    $(document.body).on('blur', 'input[name=txtCustomer]', function () 
	{
		...
		if(radCategory == 'Vendor')
		{
			var Cash = checkCashcode($(this).val()).split(';');
		
			//Cash[0] - CardCode
			//Cash[1] - CardName
			//Cash[2] - Balance
			//Cash[3] - Contact Person
			$('input[name=txtCustomer]').val(Cash[0]);
			$('input[name=txtName]').val(Cash[1]);
			$('input[name=txtContactPerson]').val(Cash[3]);

			populateARList(Cash[0], function () { });
		}
 	...
 	$(document.body).on('click','#btnSelectPrint > li > a', function () 
	{
		...
		var CompanyDb = $('select[name=selCompany]').val();

		if(href == '#CV')
		{
			if(docentry != '')
			{
				window.open("../../report/OP/op-report.php?docentry=" + encodeURI(docentry), "", "width=1130,height=550,left=220,top=110");
			}
		}
		
		if(href == '#CH')
		{
			window.open("../../report/OP/op-report1.php?docentry=" + encodeURI(docentry), "", "width=1130,height=550,left=220,top=110");
		}			
    });
	...
	$(document.body).on('change', '.price', function (e) 
	{
		var price = $(this).val().replace(/,/g, '') == '' ? '' : $(this).val().replace(/,/g, '');
		if(price != '')
		{
			$(this).val(formatMoney(parseFloat(price)));
		}
    });
	...
	$(document.body).on('keyup','input[name=txtTotalTax]',function()
	{
		...
		if(radCategory == 'Account')
		{
			$("input[name=txtTotalTax]").val(computeTotalAmount('taxamount'));
	...
	$(document.body).on('blur','.price',function()
	{
		...
		$('.selected-det').find('input.taxamount').val(computetax(price,taxrate));	
	...
	{
		var taxamount = $('.selected-det').find('input.taxamount').val().replace(/,/g,'');
		...
		{
			$('.selected-det').find('input.taxamount').val(formatMoney(parseFloat(taxamount)));
		}
	});
	
	function computetax(price,taxrate)
	{
	...
	$(document.body).on('click','#btnDisbursementListVIEW',function(e)
	{
		$('#resView').empty();
    	...
    	var txtDisbursementListFrom = $('input[name=txtDisbursementListFrom]').val();
    	var txtDisbursementListTo = $('input[name=txtDisbursementListTo]').val();
		
		if(err == 0)
		{
			$.ajax({
				type: 'POST',
				url: '../../report/op/rpt_view.php',
				data: {
					txtDateFrom : txtDateFrom,
					txtDateTo : txtDateTo,
						txtDisbursementListFrom : txtDisbursementListFrom,
					txtDisbursementListTo : txtDisbursementListTo
				},
				success: function (html) 
				{
					$('#resView').html(html);
	...
	$('#DisbursementListModal').on('shown.bs.modal',function()
	{
		$('#resView').append('<p class="text-center" id="itm-loader"><img src=../../img/ajax-loader.gif /> Loading...</p>');
	...
	$('#DisbursementListModal').on('hide.bs.modal',function()
	{
		$('#resView').empty();
	});
	...
	$(document.body).on('dblclick','#tblView tbody > tr',function()
	{
		...
		$('#DisbursementListModal').modal('hide');
	...
	$(document.body).on('click','#btnDisbursementListPDF',function(e)
	{
    	var err = 0;
    	var errmsg = '';
		var txtDateFrom = $('input[name=txtDateFrom]').val();
		...
		$('.disbursementlistrequired').each(function()
		{
			if($(this).val() == '')
			{
		...
		if(err == 0)
		{
			window.open("../../report/op/oplist-report.php?txtDisbursementListFrom=" + encodeURI(txtDisbursementListFrom) + "&txtDisbursementListTo=" + encodeURI(txtDisbursementListTo) + "&txtDateFrom=" + encodeURI(txtDateFrom) + "&txtDateTo=" + encodeURI(txtDateTo), "", "width=1130,height=550,left=220,top=110");
		}
		else
		{
	...
	$(document.body).on('click','#btnDisbursementListEXCEL',function(e)
	{
    	var err = 0;
    	var errmsg = '';
		var txtDateFrom = $('input[name=txtDateFrom]').val();
		...
		if(err == 0)
		{
			window.open("../../report/op/oplist-excel.php?txtDisbursementListFrom=" + encodeURI(txtDisbursementListFrom) + "&txtDisbursementListTo=" + encodeURI(txtDisbursementListTo) + "&txtDateFrom=" + encodeURI(txtDateFrom) + "&txtDateTo=" + encodeURI(txtDateTo), "", "width=1130,height=550,left=220,top=110");
		}
		else
		{
			notie.alert(3, errmsg, 2);
	...
	$(document.body).on('click', '#btnNewCreditCard', function (e) 
	{
        ...
        $('input[name=txtCreditCardNo]').val('');
        $('input[name=txtValidUntil]').val('');
        $('input[name=txtAmountDue]').val('');
        $('input[name=txtVoucherNo]').val('');
    ...
    //Save IP
    $(document.body).on('click', '#btnSaveOP', function (e) {
        var err = 0;
        var errmsg = '';
        ...
        var txtRemitTo = $('input[name=txtRemitTo]').val();
        ...
        var tbl2 = $('#tblDetails tbody tr').each(function (i) 
		{
			...
			else
			{
				if ($(this).find('input.itemselected').prop('checked') == true)
				{
					...
					itArr.push('"' + $(this).find('input.employeecode').val().replace(/,/g, '') + '"');
					itArr.push('"' + $(this).find('input.equipmentcode').val().replace(/,/g, '') + '"');
					itArr.push('"' + $(this).find('input.invtype').val().replace(/,/g, '') + '"');
        ...
        urlstr = '../../proc/exec/OP/exec-saveop.php';
            ...
            $.ajax({
                ...
                success: function (html) 
				{
                    ...
                    if (res[0] == 'true') {
                        ...
                        disablebuttons(true)
                        setTimeout(function () {
                            location.replace('../../forms/OP/OP.php');
                        }, 2000)
	...
	$(document.body).on('click','#btnCancelOP',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/OP/exec-cancelop.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
...
//                    itArr.push('"' + $(this).find('input.weightreceived').val().replace(/,/g, '') + '"');
//                    itArr.push('"' + $(this).find('input.weightcarcass').val().replace(/,/g, '') + '"');
//                    itArr.push('"' + $(this).find('input.weightentrails').val().replace(/,/g, '') + '"');
//                    itArr.push('"' + $(this).find('input.weighthead').val().replace(/,/g, '') + '"');
//                    itArr.push('"' + $(this).find('input.weighthlcarcass').val().replace(/,/g, '') + '"');
//                    itArr.push('"' + $(this).find('input.weightdelivery').val().replace(/,/g, '') + '"');
        ...
        if (err == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: '../../proc/exec/OP/exec-updateip.php',
                data: {
                    json: json.replace(/(\r\n|\n|\r)/gm, '[newline]'),
                    basentry: basentry,
                    customer: customer,
...
//                    alert(html);
    ...
    function checkitemcode(itemcode) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/OP/vw_checkitemcode.php',
            async: false,
            data: {
				itemcode : itemcode
			},
    ...
    function checkwhs(whscode) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/OP/vw_checkwhscode.php',
            async: false,
            data:  {
				whscode : whscode
			},
    ...
    function checkacctcode(acctcode) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/OP/vw_checkacctcode.php',
            async: false,
            data:  {
				acctcode : acctcode
			},
    ...
    function checkbpcode(bpcode) {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/OP/vw_checkbpcode.php',
            async: false,
            data: {
				bpcode : bpcode
			},
    ...
    function getdefaultaccounts()
    {
        ...
        $.ajax({
            type: 'POST',
            url: '../../proc/views/OP/vw_getdefaultaccounts.php',
            async: false,
			data : {
	...
	{
        $('#tblCreditCard tbody').load('../../proc/views/OP/vw_creditcarddetailsdata.php?docentry=' + docentry , function (result) 
		{
			callback();
        });
    }
	...
	{
        $('#tblDetails tbody').load('../../proc/views/OP/vw_documentdetailsdata.php?docentry=' + docentry , function (result) 
		{
			callback();
        });
    ...
    {
        $('#tblDetails tbody').load('../../proc/views/OP/vw_ardetailsdata.php?customer=' + customer , function (result) {
            callback();
        });
    }

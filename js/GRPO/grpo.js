...
function getDocCur(selDocCur)
	{
		...
		if(x == 'C') {
			...
			$('select[name=selDocCur]').load('../../proc/views/GRPO/vw_doccur.php', function () {
...
{
	$('#window-title').text('Goods Receipt PO');
	...
	//Initialize Title
	$('#mod-title').text('Goods Receipt PO');
	//End Initialize Title

	
    //Load Grpo Series 
    $('#btnSeries').html('Loading...')
    $('#SeriesList').load('../../proc/views/GRPO/vw_series.php?objtype=20',function(){
	...
	$('select[name=txtSalesEmployee]').load('../../proc/views/GRPO/vw_salesemployee.php');
	
	$('select[name=txtPayment]').html('<option>Loading...</option>');
	$('select[name=txtPayment]').load('../../proc/views/GRPO/vw_paymentterms.php');
    ...
    $('#OwnerModal').on('shown.bs.modal', function () {
        ...
        $('#OwnerCont').load('../../proc/views/GRPO/vw_employee.php?CardType=C', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/GRPO/vw_employee-load.php',
    ...
    $(document.body).on('keyup', 'input[name=OwnerSearch]', function () {
        ...
        $('#OwnerCont table tbody').load('../../proc/views/GRPO/vw_employee-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Owner
	...
	$(document.body).on('change','select[name=cmbServiceType]',function(){
		...
		if(servicetype == 'I'){
			...
			$('#ModDetails').load('../../forms/GRPO/GRPO-details.php?servicetype=I',function(){
			...
			$('#ModDetails').load('../../forms/GRPO/GRPO-details.php?servicetype=S',function(){
				//Clear value Total Before Discount
				$('input[name=TotBefDisc]').val('');
				//End Clear value Total Before Discount
				cback = 0;
	...
	$(document.body).on('click','#btnAddRow',function(){
		...
		if(servicetype == 'I'){
			//Item Type
			$(this).load('../../forms/GRPO/GRPO-details-row.php?servicetype=I',function(result){
			...
			//Service Type
			$(this).load('../../forms/GRPO/GRPO-details-row.php?servicetype=S',function(result){
				$('#tblDetails tbody').append(result);
	...
	$(document.body).on('click','#btnFreeText',function(){
		...
		if(servicetype == 'I'){
			//Item Type
			$(this).load('../../forms/GRPO/GRPO-details-row.php?servicetype=I&freetext=1',function(result){
	...
	$('#ItemModal').on('shown.bs.modal',function()
	{
		...
		$('#ItemCont').load('../../proc/views/GRPO/vw_itemlist.php',function(){
			//Add Scroll Function 
		        ...
		        if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/GRPO/vw_itemlist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('keyup','input[name=ItemSearch]',function(){
        ...
        $('#ItemCont table tbody').load('../../proc/views/GRPO/vw_itemlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Item
	...
	$('#WhsModal').on('shown.bs.modal',function(){
			...
			$('#WhsCont').load('../../proc/views/GRPO/vw_whslist.php',function(){
	...
	$(document.body).on('keyup','input[name=WhsSearch]',function(){
        ...
        $('#WhsCont table tbody').load('../../proc/views/GRPO/vw_whslist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Whs
	...
	$('#DepartmentModal').on('shown.bs.modal',function()
	{
		...
		$('#DepartmentCont').load('../../proc/views/GRPO/vw_deptlist.php');
	...
	$(document.body).on('keyup','input[name=DepartmentSearch]',function(){
        ...
        $('#DepartmentCont table tbody').load('../../proc/views/GRPO/vw_deptlist-load.php?srchval=' + encodeURI(searchVal));
	})
	...
	$('#ProjectModal').on('shown.bs.modal',function()
	{
		...
		$('#ProjectCont').load('../../proc/views/GRPO/vw_projlist.php');
	...
	$(document.body).on('keyup','input[name=ProjectSearch]',function(){
        ...
        $('#ProjectCont table tbody').load('../../proc/views/GRPO/vw_projlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Department
	...
	$('#EmployeeModal').on('shown.bs.modal',function()
	{
		...
		$('#EmployeeCont').load('../../proc/views/GRPO/vw_emplist.php');
	...
	$(document.body).on('keyup','input[name=EmployeeSearch]',function(){
        ...
        $('#EmployeeCont table tbody').load('../../proc/views/GRPO/vw_emplist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Department
	...
	$('#AcctModal').on('shown.bs.modal',function(){
		...
		$('#AcctCont').load('../../proc/views/GRPO/vw_acctlist.php',function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/GRPO/vw_acctlist-load.php',
		                        data: {
									itemcode : itemcode
								},
		                        success: function(html){
	...
	$(document.body).on('keyup','input[name=AcctSearch]',function(){
        ...
        $('#AcctCont table tbody').load('../../proc/views/GRPO/vw_acctlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Acct
	...
	$('#InvDataModal').on('shown.bs.modal',function(){
		...
		if(itemcode != ''){
			...
			$('#InvDataCont').load('../../proc/views/GRPO/vw_invdatalist.php?itemcode=' + itemcode,function(){
	...
	$('#DocumentModal').on('shown.bs.modal',function(){
		...
		$('#DocumentCont').load('../../proc/views/GRPO/vw_doclist.php?servicetype=' + encodeURI(servicetype),function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/GRPO/vw_doclist-load.php',
		                        data: {
									itemcode : itemcode
								},
		                        success: function(html){
	...
	$(document.body).on('keyup','input[name=DocumentSearch]',function(){
        ...
        $('#DocumentCont table tbody').load('../../proc/views/GRPO/vw_doclist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Document
	...
	$(document.body).on('keyup','input[name=txtDocEntry]',function(){
		...
		$.getJSON('../../proc/views/GRPO/vw_getdocumentdata.php?docentry=' + docentry, function(data) {
            /* data will hold the php array as a javascript object */
	            ...
	            $.each(data, function(key, val) {
	            	...
	            	if(val.DocStatus == 'C'){
						...
						// $('input[name=txtRefNo]').val(val.U_SiDr).prop('disabled',true);
	...
	$('#BPModal').on('shown.bs.modal',function(){
		...
		$('#BPCont').load('../../proc/views/GRPO/vw_bplist.php?CardType=S',function(){
			//Add Scroll Function 
		        ...
		        if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/GRPO/vw_bplist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('dblclick','#tblBP tbody > tr',function(){
		...
		$('textarea[name=txtShipTo]').load('../../proc/views/GRPO/vw_shipto.php?cardcode=' + encodeURI(BPCode));
		
		//Load Bill To
		$('textarea[name=txtBillTo]').html('Loading...');
		$('textarea[name=txtBillTo]').load('../../proc/views/GRPO/vw_billto.php?cardcode=' + encodeURI(BPCode));
	...
	$(document.body).on('keyup','input[name=BPSearch]',function(){
        ...
        $('#BPCont table tbody').load('../../proc/views/GRPO/vw_bplist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search BP
	...
	$(document.body).on('keyup','input[name=txtBaseEntry]',function(){
		...
		if(basentry != ''){
			//Show Base Document
			//Get PR data using JSON
			$.getJSON('../../proc/views/GRPO/vw_getpodata.php?docentry=' + basentry + '', function(data) {
	            /* data will hold the php array as a javascript object */
           		...
           		$.each(data, function(key, val) {
	            	...
	            	if(val.DocStatus == 'C'){
		            	...
		            	if(val.Comments == '')
						{
							$('textarea[name=txtRemarksF]').val('PO#' + val.NumAtCard + '.').prop('disabled',true);
						}
						else
						{
						...
						if(val.Comments == '')
						{
							$('textarea[name=txtRemarksF]').val('PO#' + val.NumAtCard + '.').prop('disabled',false);
						}
						else
						{
	...
	$(document.body).on('click','#btnPrint',function(){
		...
		if(docentry != ''){
			...
			window.open("../../report/GRPO/grpo-report.php?docentry=" + encodeURI(docentry), "", "width=1130,height=550,left=220,top=110");
		}
	})
	//End Print Document
    ...
    $('#POModal').on('shown.bs.modal', function () {
        ...
        $('#POCont').load('../../proc/views/GRPO/vw_podoclist.php?vendor=' + encodeURI(vendor), function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/GRPO/vw_podoclist-load.php?vendor=' + encodeURI(vendor),
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
    ...
    $(document.body).on('keyup', 'input[name=POSearch]', function () {
        ...
        $('#POCont table tbody').load('../../proc/views/GRPO/vw_podoclist-load.php?srchval=' + encodeURI(searchVal) + '&vendor=' + encodeURI(vendor));
    })
    //End Search Document
	...
	$(document.body).on('click','#btnRRListPDF',function(e)
	{
    	var err = 0;
    	var errmsg = '';
    	var txtDateFrom = $('input[name=txtDateFrom]').val();
		...
		if(err == 0)
		{
			window.open("../../report/grpo/rrlist-report.php?txtAPVListFrom=" + encodeURI(txtAPVListFrom) + "&txtAPVListTo=" + encodeURI(txtAPVListTo) + "&txtDateFrom=" + encodeURI(txtDateFrom) + "&txtDateTo=" + encodeURI(txtDateTo), "", "width=1130,height=550,left=220,top=110");
		}
		else
		{
	...
	$(document.body).on('click','#btnRRListEXCEL',function(e)
	{
    	var err = 0;
    	var errmsg = '';
    	var txtDateFrom = $('input[name=txtDateFrom]').val();
		...
		if(err == 0)
		{
			window.open("../../report/grpo/rrlist-excel.php?txtAPVListFrom=" + encodeURI(txtAPVListFrom) + "&txtAPVListTo=" + encodeURI(txtAPVListTo)  + "&txtDateFrom=" + encodeURI(txtDateFrom) + "&txtDateTo=" + encodeURI(txtDateTo), "", "width=1130,height=550,left=220,top=110");
		}
		else
		{
			notie.alert(3, errmsg, 2);
	...
	//Save GRPO
    $(document.body).on('click','#btnSaveGRPO',function(e){
		...
		var txtDiscPercentF = $('input[name=txtDiscPercentF]').val();
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/GRPO/exec-savegrpo.php',
                data: {
                		json : json.replace(/(\r\n|\n|\r)/gm, '[newline]'),
                		basentry : basentry,
                		vendor : vendor,
						...
						shipto : shipto,
						billto : billto,
						txtDiscPercentF : txtDiscPercentF,
						txtTotalPaymentDue : txtTotalPaymentDue
                ...
                success: function(html){
					...
					if(res[0] == 'true'){
						...
						disablebuttons(true)
						setTimeout(function(){
							location.replace('../../forms/GRPO/GRPO.php');
						},2000)
	...
	//Canceled SO
    $(document.body).on('click','#btnCancelGRPO',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/GRPO/exec-cancelgrpo.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
	...
	//Closed SO
    $(document.body).on('click','#btnCloseGRPO',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/GRPO/exec-closegrpo.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
	...
	function checkitemcode(itemcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/GRPO/vw_checkitemcode.php',
	        async: false,
	        data: {
				itemcode : itemcode
			},
	...
	function checkwhs(whscode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/GRPO/vw_checkwhscode.php',
	        async: false,
	        data: {
				whscode : whscode
			},
	...
	function checkacctcode(acctcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/GRPO/vw_checkacctcode.php',
	        async: false,
	        data: {
				acctcode : acctcode
			},
	...
	function checkbpcode(bpcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/GRPO/vw_checkbpcode.php',
	        async: false,
	        data: {
				bpcode : bpcode
			},
	...
	function populatedetPOMulti(docentry, callback) {
        ...
        $('#tblDetails tbody').load('../../proc/views/GRPO/vw_podetailsdata-multi.php?docentry=' + encodeURI(docentry), function (result) {
	...
	function populatedet(docentry, callback){
		...
		$('#tblDetails tbody').load('../../proc/views/GRPO/vw_documentdetailsdata.php?docentry=' + docentry,function(result){
	...
	{
		$('#tblDetails tbody').load('../../proc/views/GRPO/vw_podetailsdata.php?docentry=' + docentry,function(result)
		{
			callback();
		});
	}

...
function getDocCur(selDocCur)
	{
		...
		if(x == 'C') {
			...
			$('select[name=selDocCur]').load('../../proc/views/DR/vw_doccur.php', function () {
...
$(document).ready(function() 
{
	...
	//Initialize Title
	$('#mod-title').text('Delivery');
	//End Initialize Title
	
    //Load SO Series 
    $('#btnSeries').html('Loading...')
    $('#SeriesList').load('../../proc/views/DR/vw_series.php?objtype=15',function(){
	...
	$('select[name=txtSalesEmployee]').load('../../proc/views/DR/vw_salesemployee.php');
	
	$('select[name=txtPayment]').html('<option>Loading...</option>');
	$('select[name=txtPayment]').load('../../proc/views/DR/vw_paymentterms.php');
	
	$('#OwnerModal').on('shown.bs.modal', function () {

        $('#OwnerCont').html('<p class="text-center"><img src=../../img/ajax-loader.gif /> Loading...</p>');
        $('#OwnerCont').load('../../proc/views/DR/vw_employee.php?CardType=C', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/DR/vw_employee-load.php',
    ...
    $(document.body).on('keyup', 'input[name=OwnerSearch]', function () {
        ...
        $('#OwnerCont table tbody').load('../../proc/views/DR/vw_employee-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Owner
	...
	$(document.body).on('change','select[name=cmbServiceType]',function(){
		...
		if(servicetype == 'I'){
			...
			$('#ModDetails').load('../../forms/DR/DR-details.php?servicetype=I',function(){
			...
			$('#ModDetails').load('../../forms/DR/DR-details.php?servicetype=S',function(){
				//Clear value Total Before Discount
				$('input[name=TotBefDisc]').val('');
				//End Clear value Total Before Discount
				cback = 0;
	...
	$(document.body).on('click','#btnAddRow',function(){
		...
		if(servicetype == 'I'){
			//Item Type
			$(this).load('../../forms/DR/DR-details-row.php?servicetype=I',function(result){
			...
			//Service Type
			$(this).load('../../forms/DR/DR-details-row.php?servicetype=S',function(result){
				$('#tblDetails tbody').append(result);
	...
	$(document.body).on('click','#btnDelRow',function()
	{
		...
		var txtBaseEntry = $('#txtBaseEntry').val();
		var linenum = $('.selected-det').find('input.lineno').val();
		
		if(linenum == '' || txtBaseEntry != '')
		{
			$('.selected-det').remove();
		...
		else
		{
			...
			$.ajax({
				type: 'POST',
				url: '../../proc/exec/dr/exec-delete-dr.php',
				data: 
				{
	...
	$('#ItemModal').on('shown.bs.modal',function()
	{
		...
		$('#ItemCont').load('../../proc/views/DR/vw_itemlist.php',function()
		{
			//Add Scroll Function 
		        ...
		        if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/DR/vw_itemlist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('dblclick','#tblItem tbody > tr',function()
	{
		...
		var form_data =
			...
			$.ajax({
			type: "POST",
			url: "../../proc/views/DR/vw_pricelist.php",
			data: form_data,
			success: function(html)
				{
					result = html;
	...
	$(document.body).on('keyup','input[name=ItemSearch]',function()
	{
        ...
        $('#ItemCont table tbody').load('../../proc/views/DR/vw_itemlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Item
	...
	$(document.body).on('blur','#tblDetails .itemcode',function(){
		...
		if(item[7] == 'T'){
			...
			if(appendbom != 1){
				...
				//Get BOM
				$('#btnAddRow').load('../../proc/views/DR/vw_bom.php?itemcode=' + encodeURI(item[0]),function(result){
	...
	$('#WhsModal').on('shown.bs.modal',function(){
			...
			$('#WhsCont').load('../../proc/views/DR/vw_whslist.php',function(){
	...
	$(document.body).on('keyup','input[name=WhsSearch]',function(){
        ...
        $('#WhsCont table tbody').load('../../proc/views/DR/vw_whslist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Whs
	...
	$('#DepartmentModal').on('shown.bs.modal',function()
	{
		...
		$('#DepartmentCont').load('../../proc/views/DR/vw_deptlist.php');
	...
	$(document.body).on('keyup','input[name=DepartmentSearch]',function(){
        ...
        $('#DepartmentCont table tbody').load('../../proc/views/DR/vw_deptlist-load.php?srchval=' + encodeURI(searchVal));
	})
	...
	$('#ProjectModal').on('shown.bs.modal',function()
	{
		...
		$('#ProjectCont').load('../../proc/views/DR/vw_projlist.php');
	...
	$(document.body).on('keyup','input[name=ProjectSearch]',function(){
        ...
        $('#ProjectCont table tbody').load('../../proc/views/DR/vw_projlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Department
	...
	$('#EmployeeModal').on('shown.bs.modal',function()
	{
		...
		$('#EmployeeCont').load('../../proc/views/DR/vw_emplist.php');
	...
	$(document.body).on('keyup','input[name=EmployeeSearch]',function(){
        ...
        $('#EmployeeCont table tbody').load('../../proc/views/DR/vw_emplist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Employee
	...
	$('#EquipmentModal').on('shown.bs.modal',function()
	{
		...
		$('#EquipmentCont').load('../../proc/views/DR/vw_equiplist.php');
	...
	$(document.body).on('keyup','input[name=EquipmentSearch]',function(){
		...
		$('#EquipmentCont table tbody').load('../../proc/views/DR/vw_equiplist-load.php?srchval=' + encodeURI(searchVal));
	})
	...
	$('#AcctModal').on('shown.bs.modal',function()
	{
		...
		$('#AcctCont').load('../../proc/views/DR/vw_acctlist.php',function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/DR/vw_acctlist-load.php',
		                        data: 
								{
									itemcode : itemcode
								},
	...
	$(document.body).on('keyup','input[name=AcctSearch]',function(){
        ...
        $('#AcctCont table tbody').load('../../proc/views/DR/vw_acctlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Acct
	...
	$('#InvDataModal').on('shown.bs.modal',function(){
		...
		if(itemcode != ''){
			...
			$('#InvDataCont').load('../../proc/views/DR/vw_invdatalist.php?itemcode=' + itemcode,function(){
	...
	$('#DocumentModal').on('shown.bs.modal',function(){
		...
		$('#DocumentCont').load('../../proc/views/DR/vw_doclist.php?servicetype=' + encodeURI(servicetype),function(){
			//Add Scroll Function 
				...
				if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/DR/vw_doclist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('keyup','input[name=DocumentSearch]',function(){
        ...
        $('#DocumentCont table tbody').load('../../proc/views/DR/vw_doclist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Document
	...
	$(document.body).on('keyup','input[name=txtDocEntry]',function(){
		...
		$.getJSON('../../proc/views/DR/vw_getdocumentdata.php?docentry=' + docentry, function(data) {
	...
	$('#BPModal').on('shown.bs.modal',function(){
		...
		$('#BPCont').load('../../proc/views/DR/vw_bplist.php?CardType=C',function()
		{
			//Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/DR/vw_bplist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('dblclick','#tblBP tbody > tr',function(){
		...
		//Load Ship To
		$('select[name=selShipTo]').html('<option>Loading...</option>');
		$('select[name=selShipTo]').load('../../proc/views/DR/vw_shipto.php?cardcode=' + encodeURI(BPCode));
		
		//Load Bill To
		$('select[name=selBillTo]').html('<option>Loading...</option>');
		$('select[name=selBillTo]').load('../../proc/views/DR/vw_billto.php?cardcode=' + encodeURI(BPCode));
	...
	$(document.body).on('keyup','input[name=BPSearch]',function(){
        ...
        $('#BPCont table tbody').html('<tr><td class="text-center" colspan="7"><p><img src=../../img/ajax-loader.gif /></p></td></tr>');
         $('#BPCont table tbody').load('../../proc/views/DR/vw_bplist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search BP
	...
	$(document.body).on('keyup','input[name=txtBaseEntry]',function(){
		...
		if(basentry != ''){
			//Show Base Document
			//Get PR data using JSON
			$.getJSON('../../proc/views/DR/vw_getsodata.php?docentry=' + basentry, function(data) {
	            /* data will hold the php array as a javascript object */
	...
	$(document.body).on('click','#btnPrint',function(){
		...
		if(docentry != ''){
			...
			window.open("../../report/DR/dr-report.php?docentry=" + encodeURI(docentry), "", "width=1130,height=550,left=220,top=110");
		}
	})
	//End Print Document
    ...
    $('#SOModal').on('shown.bs.modal', function () 
	{
        ...
        $('#SOCont').load('../../proc/views/DR/vw_sodoclist.php?vendor=' + encodeURI(vendor), function () 
		{
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) 
				{
                    if ($(this).scrollTop() > 0) 
					{
                        ...
                        if (ctr == 0) 
						{
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/DR/vw_sodoclist-load.php?vendor=' + encodeURI(vendor),
                                data: {
									itemcode : itemcode
								},
                                success: function (html) 
    ...
    $('#SOModal').on('hide.bs.modal', function () 
	{
        $('#POCont').empty();
	});
    ...
    $('#SOModal').keydown(function (e) 
	{
        switch (e.which) {
            ...
            case 40: // down
                ...
                //Check if selected
                if ($('#tblSODocument tbody').find('tr.selected-whs').index() >= 0) {
                    $('tr.selected-whs').next().trigger('click');

                    //$('#WhsCont > .table-responsive').scrollTop(10);
                } else {
                    $('#tblSODocument tbody > tr:first').trigger('click');
                }
                //End
                break;
    ...
    $(document.body).on('keyup', 'input[name=SOSearch]', function () 
	{
        ...
        $('#SOCont table tbody').load('../../proc/views/DR/vw_sodoclist-load.php?srchval=' + encodeURI(searchVal) + '&vendor=' + encodeURI(vendor));
    });
    //End Search Document
    ...
    $(document.body).on('keyup', 'input[name=SOSearch]', function () 
	{
        var $rows = $('#SOCont table tbody tr');
	...
	$('#SerialModal').on('shown.bs.modal',function(){
		...
		var baseEntry = $('#txtBaseEntry').val();
		...
		if(lineno == '')
		{
			$.ajax({
			type: "POST",
			url: "../../proc/views/DR/vw_itemcode-serial.php",
		...
		else
		{
			...
			if(serialno == '') 
				...
				$.ajax({
				type: "POST",
				url: "../../proc/views/DR/vw_setserial.php",
				data: form_data,
				success: function(data)
					{
	...
	//Save PO
    $(document.body).on('click','#btnSaveDR',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/DR/exec-savedr.php',
                data: {
                		json : json.replace(/(\r\n|\n|\r)/gm, '[newline]'),
                		basentry : basentry,
                		vendor : vendor,
                ...
                success: function(html){
					...
					if(res[0] == 'true'){
						...
						disablebuttons(true)
						setTimeout(function(){
							location.replace('../../forms/DR/DR.php');
						},2000)
    ...
    $(document.body).on('click','#btnUpdate',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/DR/exec-updatedr.php',
                data: {
                		json : json.replace(/(\r\n|\n|\r)/gm, '[newline]'),
                		basentry : basentry,
                		vendor : vendor,
	...
	//Canceled SO
    $(document.body).on('click','#btnCancelDR',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/DR/exec-canceldr.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
	...
	//Closed SO
    $(document.body).on('click','#btnCloseDR',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/DR/exec-closedr.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
	...
	function checkitemcode(itemcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/DR/vw_checkitemcode.php',
	        async: false,
	        data: { 
					itemcode : itemcode
			},
	...
	function checkwhs(whscode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/DR/vw_checkwhscode.php',
	        async: false,
	        data: {
				whscode : whscode
			}, 
	...
	function checkacctcode(acctcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/DR/vw_checkacctcode.php',
	        async: false,
	        data: {
				acctcode : acctcode
			},
	...
	function checkbpcode(bpcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/DR/vw_checkbpcode.php',
	        async: false,
	        data: {
				bpcode : bpcode
			},
	...
	function populatedet(docentry, callback){
		...
		$('#tblDetails tbody').load('../../proc/views/DR/vw_documentdetailsdata.php?docentry=' + docentry,function(result){
	...
	function populatedetSO(docentry,callback){
		...
		$('#tblDetails tbody').load('../../proc/views/DR/vw_sodetailsdata.php?docentry=' + docentry,function(result){

$(window).load(function() {
    ...
    $('#window-title').text('A/R Credit Memo');
...
function getDocCur(selDocCur)
	{
		...
		if(x == 'C') {
			...
			$('select[name=selDocCur]').load('../../proc/views/ARCM/vw_doccur.php', function () {
...
$(document).ready(function() 
{
	...
	//Initialize Title
	$('#mod-title').text('A/R Credit Memo');
	//End Initialize Title

	
    //Load SO Series 
    $('#btnSeries').html('Loading...');
    $('#SeriesList').load('../../proc/views/ARCM/vw_series.php?objtype=14',function(){
	...
	$('select[name=txtSalesEmployee]').load('../../proc/views/ARCM/vw_salesemployee.php');
	
	$('select[name=txtPayment]').html('<option>Loading...</option>');
	$('select[name=txtPayment]').load('../../proc/views/ARCM/vw_paymentterms.php');
   
    $('#OwnerModal').on('shown.bs.modal', function () 
	{
		
        $('#OwnerCont').html('<p class="text-center"><img src=../../img/ajax-loader.gif /> Loading...</p>');
        $('#OwnerCont').load('../../proc/views/ARCM/vw_employee.php?CardType=C', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/ARCM/vw_employee-load.php',
                                data: {
									itemcode : itemcode
								},
    ...
    $(document.body).on('keyup', 'input[name=OwnerSearch]', function () {
        ...
        $('#OwnerCont table tbody').load('../../proc/views/ARCM/vw_employee-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Owner
	...
	$(document.body).on('change','select[name=cmbServiceType]',function()
	{
		...
		if(servicetype == 'I'){
			...
			$('#ModDetails').load('../../forms/ARCM/ARCM-details.php?servicetype=I',function(){
			...
			$('#ModDetails').load('../../forms/ARCM/ARCM-details.php?servicetype=S',function(){
				//Clear value Total Before Discount
				$('input[name=TotBefDisc]').val('');
				//End Clear value Total Before Discount
				cback = 0;
	...
	$(document.body).on('click','#btnAddRow',function(){
		...
		if(servicetype == 'I'){
			//Item Type
			$(this).load('../../forms/ARCM/ARCM-details-row.php?servicetype=I',function(result){
			...
			//Service Type
			$(this).load('../../forms/ARCM/ARCM-details-row.php?servicetype=S',function(result){
				$('#tblDetails tbody').append(result);
	...
	$('#ItemModal').on('shown.bs.modal',function(){
		...
		$('#ItemCont').load('../../proc/views/ARCM/vw_itemlist.php',function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/ARCM/vw_itemlist-load.php',
		                        data: {
									itemcode : itemcode
								},
		                        success: function(html){
	...
	$(document.body).on('dblclick','#tblItem tbody > tr',function(){
		...
		var form_data =
			...
			$.ajax({
			type: "POST",
			url: "../../proc/views/ARCM/vw_pricelist.php",
			data: form_data,
			success: function(html)
				{
					result = html;
	...
	$(document.body).on('keyup','input[name=ItemSearch]',function(){
        ...
        $('#ItemCont table tbody').load('../../proc/views/ARCM/vw_itemlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Item
	...
	$('#WhsModal').on('shown.bs.modal',function(){
			...
			$('#WhsCont').load('../../proc/views/ARCM/vw_whslist.php',function(){
	...
	$(document.body).on('keyup','input[name=WhsSearch]',function(){
        ...
        $('#WhsCont table tbody').load('../../proc/views/ARCM/vw_whslist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Whs
	...
	$('#DepartmentModal').on('shown.bs.modal',function()
	{
		...
		$('#DepartmentCont').load('../../proc/views/ARCM/vw_deptlist.php');
	...
	$(document.body).on('keyup','input[name=DepartmentSearch]',function(){
        ...
        $('#DepartmentCont table tbody').load('../../proc/views/ARCM/vw_deptlist-load.php?srchval=' + encodeURI(searchVal));
	})
	...
	$('#ProjectModal').on('shown.bs.modal',function()
	{
		...
		$('#ProjectCont').load('../../proc/views/ARCM/vw_projlist.php');
	...
	$(document.body).on('keyup','input[name=ProjectSearch]',function(){
        ...
        $('#ProjectCont table tbody').load('../../proc/views/ARCM/vw_projlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Department
	...
	$('#EmployeeModal').on('shown.bs.modal',function()
	{
		...
		$('#EmployeeCont').load('../../proc/views/ARCM/vw_emplist.php');
	...
	$(document.body).on('keyup','input[name=EmployeeSearch]',function(){
        ...
        $('#EmployeeCont table tbody').load('../../proc/views/ARCM/vw_emplist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Employee
		...
		$('#EquipmentModal').on('shown.bs.modal',function()
		{
			...
			$('#EquipmentCont').load('../../proc/views/ARCM/vw_equiplist.php');
		...
		$(document.body).on('keyup','input[name=EquipmentSearch]',function(){
			...
			$('#EquipmentCont table tbody').load('../../proc/views/ARCM/vw_equiplist-load.php?srchval=' + encodeURI(searchVal));
		})
	...
	$('#AcctModal').on('shown.bs.modal',function(){
		...
		$('#AcctCont').load('../../proc/views/ARCM/vw_acctlist.php',function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/ARCM/vw_acctlist-load.php',
		                        data: {
									itemcode : itemcode
								},
		                        success: function(html){
	...
	$(document.body).on('keyup','input[name=AcctSearch]',function(){
        ...
        $('#AcctCont table tbody').load('../../proc/views/ARCM/vw_acctlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Acct
	...
	$('#InvDataModal').on('shown.bs.modal',function(){
		...
		if(itemcode != ''){
			...
			$('#InvDataCont').load('../../proc/views/ARCM/vw_invdatalist.php?itemcode=' + itemcode,function(){
	...
	$('#DocumentModal').on('shown.bs.modal',function(){
		...
		$('#DocumentCont').load('../../proc/views/ARCM/vw_doclist.php',function(){
			//Add Scroll Function 
				...
				if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/ARCM/vw_doclist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('keyup','input[name=DocumentSearch]',function(){
        ...
        $('#DocumentCont table tbody').load('../../proc/views/ARCM/vw_doclist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Document
	...
	$(document.body).on('keyup','input[name=txtDocEntry]',function(){
		...
		$.getJSON('../../proc/views/ARCM/vw_getdocumentdata.php?docentry=' + docentry, function(data) {
			...
			$('#modal-load-init').modal('show');
           		...
           		$.each(data, function(key, val) {
	            	...
	            	if(val.DocStatus == 'C'){
						...
						$('select[name=selContactPerson]').load('../../proc/views/ARCM/vw_contactlist.php?cardcode=' + val.CardCode, function () {
						...
						$('select[name=selShipTo]').load('../../proc/views/ARCM/vw_sel_shipto.php?cardcode=' + val.CardCode, function () {
							$('select[name=selShipTo]').val(val.ShipToCode).prop('disabled',true);
							})
						
						$('select[name=selBillTo]').html('<option>Loading...</option>');
						$('select[name=selBillTo]').load('../../proc/views/ARCM/vw_sel_billto.php?cardcode=' + val.CardCode, function () {
	...
	$('#BPModal').on('shown.bs.modal',function(){
		...
		$('#BPCont').load('../../proc/views/ARCM/vw_bplist.php?CardType=C',function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/ARCM/vw_bplist-load.php',
		                        data: {
									itemcode : itemcode
								},
		                        success: function(html){
	...
	$(document.body).on('dblclick','#tblBP tbody > tr',function(){
		...
		$('select[name=selContactPerson]').load('../../proc/views/ARCM/vw_contactlist.php?cardcode=' + encodeURI(BPCode));
		...
		//Load Ship To
		$('select[name=selShipTo]').html('<option>Loading...</option>');
		$('select[name=selShipTo]').load('../../proc/views/ARCM/vw_sel_shipto.php?cardcode=' + encodeURI(BPCode));
		
		//Load Bill To
		$('select[name=selBillTo]').html('<option>Loading...</option>');
		$('select[name=selBillTo]').load('../../proc/views/ARCM/vw_sel_billto.php?cardcode=' + encodeURI(BPCode));
		
		//Load Ship To
		$('textarea[name=txtShipTo]').html('Loading...');
		$('textarea[name=txtShipTo]').load('../../proc/views/ARCM/vw_shipto.php?cardcode=' + encodeURI(BPCode));
		
		//Load Bill To
		$('textarea[name=txtBillTo]').html('Loading...');
		$('textarea[name=txtBillTo]').load('../../proc/views/ARCM/vw_billto.php?cardcode=' + encodeURI(BPCode));
	...
	$(document.body).on('keyup','input[name=BPSearch]',function(){
        ...
        $('#BPCont table tbody').load('../../proc/views/ARCM/vw_bplist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search BP
	...
	$(document.body).on('change','select[name=selShipTo]',function(){
		...
		//Load Ship To
		$('textarea[name=txtShipTo]').html('Loading...');
		$('textarea[name=txtShipTo]').load('../../proc/views/ARCM/vw_shipto-load.php?cardcode=' + CardCode +'&addressid='+ AddressId);
	...
	$(document.body).on('change','select[name=selBillTo]',function(){
		...
		//Load Bill To
		$('textarea[name=txtBillTo]').html('Loading...');
		$('textarea[name=txtBillTo]').load('../../proc/views/ARCM/vw_billto-load.php?cardcode=' + CardCode +'&addressid='+ AddressId);
	...
	$(document.body).on('keyup','input[name=txtBaseEntry]',function()
	{
		...
		if(basentry != ''){
			...
			$.getJSON('../../proc/views/ARCM/vw_getdrdata.php?docentry=' + basentry, function(data) {
	            /* data will hold the php array as a javascript object */
	...
	$(document.body).on('keyup','input[name=txtBaseEntry1]',function()
	{
		...
		if(basentry != ''){
			//Show Base Document
			//Get PR data using JSON
			$.getJSON('../../proc/views/ARCM/vw_getsodata.php?docentry=' + basentry, function(data) {
	            /* data will hold the php array as a javascript object */
	...
	$('#SOModal').on('shown.bs.modal', function () 
	{
        ...
        $('#SOCont').load('../../proc/views/ARCM/vw_drdoclist.php?vendor=' + encodeURI(vendor), function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/ARCM/vw_drdoclist-load.php?vendor=' + encodeURI(vendor),
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$('#SO1Modal').on('shown.bs.modal', function () 
	{
        ...
        $('#SO1Cont').load('../../proc/views/ARCM/vw_sodoclist.php?vendor=' + encodeURI(vendor), function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/ARCM/vw_sodoclist-load.php?vendor=' + encodeURI(vendor),
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('keyup', 'input[name=DRSearch]', function () {
        ...
        $('#SOCont table tbody').load('../../proc/views/ARCM/vw_drdoclist-load.php?srchval=' + encodeURI(searchVal) + '&vendor=' + encodeURI(vendor));
    });
	...
	$(document.body).on('keyup', 'input[name=SOSearch]', function () {
        ...
        $('#SO1Cont table tbody').load('../../proc/views/ARCM/vw_sodoclist-load.php?srchval=' + encodeURI(searchVal) + '&vendor=' + encodeURI(vendor));
    });
	...
	/* $(document.body).on('click','#btnSelectPrint',function(){
		...
		if(docentry != ''){
			...
			window.open("../../report/ARCM/ARCM-report.php?docentry=" + encodeURI(docentry), "", "width=1130,height=550,left=220,top=110");
	...
	$(document.body).on('click','#btnSelectPrint > li > a', function () 
	{
		...
		if(href == '#CI')
		{
			window.open("../../report/ARCM/ci-report.php?docentry=" + encodeURI(docentry), "", "width=1130,height=550,left=220,top=110");
		}			
    });
	...
	$('#EmailModal').on('shown.bs.modal',function(){
		...
		$.ajax({
		type: "POST",
		url: "../../proc/views/ARCM/vw_email.php",
	...
	$('#SerialModal').on('shown.bs.modal',function(){
		...
		if(lineno == '')
		{
			$.ajax({
			type: "POST",
			url: "../../proc/views/ARCM/vw_itemcode-serial.php",
		...
		else
		{
			...
			$.ajax({
			type: "POST",
			url: "../../proc/views/ARCM/vw_setserial.php",
			data: form_data,
			success: function(data)
				{
	...
	$(document.body).on('click','#btnARListPDF',function(e)
	{
		...
		if(err == 0)
		{
			window.open("../../report/ARCM/arlist-report.php?txtARListFrom=" + encodeURI(txtARListFrom) + "&txtARListTo=" + encodeURI(txtARListTo) + "&txtDateFrom=" + encodeURI(txtDateFrom) + "&txtDateTo=" + encodeURI(txtDateTo), "", "width=1130,height=550,left=220,top=110");
		}
		else
		{
	...
	$(document.body).on('click','#btnARListEXCEL',function(e)
	{
		...
		if(err == 0)
		{
			window.open("../../report/ARCM/arlist-excel.php?txtARListFrom=" + encodeURI(txtARListFrom) + "&txtARListTo=" + encodeURI(txtARListTo) + "&txtDateFrom=" + encodeURI(txtDateFrom) + "&txtDateTo=" + encodeURI(txtDateTo), "", "width=1130,height=550,left=220,top=110");
		}
		else
		{
			notie.alert(3, errmsg, 2);
    ...
    $(document.body).on('click','#btnSaveInv',function(e){
		...
		if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/ARCM/exec-save.php',
                data: {
                		json : json.replace(/(\r\n|\n|\r)/gm, ''),
                		basentry : basentry,
                		basentry1 : basentry1,
                ...
                success: function(html){
					...
					if(res[0] == 'true')
					{
						...
						disablebuttons(true);
						setTimeout(function(){
							location.replace('../../forms/ARCM/ARCM.php');
						},1000);
	...
	$(document.body).on('click','#btnSaveInv1',function(e)
	{
		...
		if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/ARCM/exec-savesi.php',
                data: {
                		json : json.replace(/(\r\n|\n|\r)/gm, '[newline]'),
                		basentry : basentry,
                		basentry1 : basentry1,
	...
	$(document.body).on('click','#btnAddContact',function(e){
		...
		if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/ARCM/exec-savecontact.php',
                data: {
    ...
    $(document.body).on('click','#btnUpdate',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/ARCM/exec-updatesi.php',
                data: {
                		contactperson : contactperson,
						numatcard : numatcard,
    ...
    $(document.body).on('click','#btnCancelInv',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/ARCM/exec-cancelsi.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
	...
	function checkitemcode(itemcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/ARCM/vw_checkitemcode.php',
	        async: false,
	        data: {
				itemcode : itemcode
			},
	...
	function checkserialno(serialno){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/ARCM/vw_checkserial.php',
	        async: false,
	...
	function checkwhs(whscode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/ARCM/vw_checkwhscode.php',
	        async: false,
	        data: {
				whscode : whscode
			},
	...
	function checkacctcode(acctcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/ARCM/vw_checkacctcode.php',
	        async: false,
	        data: {
				acctcode : acctcode
			},
	...
	function checkbpcode(bpcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/ARCM/vw_checkbpcode.php',
	        async: false,
	        data: {
				bpcode : bpcode
			},
	...
	function populatedet(docentry,callback){
		...
		$('#tblDetails tbody').load('../../proc/views/ARCM/vw_documentdetailsdata.php?docentry=' + docentry,function(result){
	...
	function populatedetDR(docentry,callback){
		...
		$('#tblDetails tbody').load('../../proc/views/ARCM/vw_drdetailsdata.php?docentry=' + docentry,function(result){
	...
	function populatedetSO(docentry,callback){
		...
		$('#tblDetails tbody').load('../../proc/views/ARCM/vw_sodetailsdata.php?docentry=' + docentry,function(result){

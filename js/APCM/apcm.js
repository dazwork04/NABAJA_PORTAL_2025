...
function getDocCur(selDocCur)
	{
		...
		if(x == 'C') {
			...
			$('select[name=selDocCur]').load('../../proc/views/APCM/vw_doccur.php', function () {
...
$(document).ready(function() 
{
	...
	$('#window-title').text('A/P Credit Memo');
	...
	//Initialize Title
	$('#mod-title').text('A/P Credit Memo');
	//End Initialize Title

	
    //Load Grpo Series 
    $('#btnSeries').html('Loading...')
    $('#SeriesList').load('../../proc/views/APCM/vw_series.php?objtype=19',function(){
	...
	$('select[name=txtSalesEmployee]').load('../../proc/views/APCM/vw_salesemployee.php');
	
	$('select[name=txtPayment]').html('<option>Loading...</option>');
	$('select[name=txtPayment]').load('../../proc/views/APCM/vw_paymentterms.php');
    ...
    $('#OwnerModal').on('shown.bs.modal', function () {
        ...
        $('#OwnerCont').load('../../proc/views/APCM/vw_employee.php?CardType=C', function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/APCM/vw_employee-load.php',
    ...
    $(document.body).on('keyup', 'input[name=OwnerSearch]', function () {
        ...
        $('#OwnerCont table tbody').load('../../proc/views/APCM/vw_employee-load.php?srchval=' + encodeURI(searchVal));
    })
    //End Search Owner
    ...
    $(document.body).on('click','.series',function(){
 	...
 	$(document.body).on('change','select[name=cmbServiceType]',function(){
		...
		if(servicetype == 'I'){
			...
			$('#ModDetails').load('../../forms/APCM/APCM-details.php?servicetype=I',function(){
			...
			$('#ModDetails').load('../../forms/APCM/APCM-details.php?servicetype=S',function(){
				//Clear value Total Before Discount
				$('input[name=TotBefDisc]').val('');
				//End Clear value Total Before Discount
				cback = 0;
	...
	$(document.body).on('click','#btnAddRow',function(){
		...
		if(servicetype == 'I'){
			//Item Type
			$(this).load('../../forms/APCM/APCM-details-row.php?servicetype=I',function(result){
			...
			//Service Type
			$(this).load('../../forms/APCM/APCM-details-row.php?servicetype=S',function(result){
				$('#tblDetails tbody').append(result);
	...
	$(document.body).on('click','#btnFreeText',function(){
		...
		if(servicetype == 'I'){
			//Item Type
			$(this).load('../../forms/APCM/APCM-details-row.php?servicetype=I&freetext=1',function(result){
	...
	$('#ItemModal').on('shown.bs.modal',function(){
		...
		$('#ItemCont').load('../../proc/views/APCM/vw_itemlist.php',function(){
			//Add Scroll Function 
		        ...
		        if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/APCM/vw_itemlist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('dblclick','#tblItem tbody > tr',function(){
		...
		var form_data =
			...
			url: "../../proc/views/APCM/vw_pricelist.php",
			data: form_data,
			success: function(html)
				{
					result = html;
	...
	$(document.body).on('keyup','input[name=ItemSearch]',function(){
        ...
        $('#ItemCont table tbody').load('../../proc/views/APCM/vw_itemlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Item
	...
	$('#WTaxCodeModal').on('shown.bs.modal',function()
	{
		...
		$('#WTaxCodeCont').load('../../proc/views/APCM/vw_withholdingtaxtable.php?vendorcode=' + encodeURI(vendor) ,function()
		{
	...
	$('#WhsModal').on('shown.bs.modal',function(){
			...
			$('#WhsCont').load('../../proc/views/APCM/vw_whslist.php',function(){
	...
	$(document.body).on('keyup','input[name=WhsSearch]',function(){
        ...
        $('#WhsCont table tbody').load('../../proc/views/APCM/vw_whslist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Whs
	...
	$('#DepartmentModal').on('shown.bs.modal',function()
	{
		...
		$('#DepartmentCont').load('../../proc/views/APCM/vw_deptlist.php');
	...
	$(document.body).on('keyup','input[name=DepartmentSearch]',function(){
        ...
        $('#DepartmentCont table tbody').load('../../proc/views/APCM/vw_deptlist-load.php?srchval=' + encodeURI(searchVal));
	})
	...
	$('#ProjectModal').on('shown.bs.modal',function()
	{
		...
		$('#ProjectCont').load('../../proc/views/APCM/vw_projlist.php');
	...
	$(document.body).on('keyup','input[name=ProjectSearch]',function(){
        ...
        $('#ProjectCont table tbody').load('../../proc/views/APCM/vw_projlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Department
	...
	$('#EmployeeModal').on('shown.bs.modal',function()
	{
		...
		$('#EmployeeCont').load('../../proc/views/APCM/vw_emplist.php');
	...
	$(document.body).on('keyup','input[name=EmployeeSearch]',function(){
        ...
        $('#EmployeeCont table tbody').load('../../proc/views/APCM/vw_emplist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Employee
		...
		$('#EquipmentModal').on('shown.bs.modal',function()
		{
			...
			$('#EquipmentCont').load('../../proc/views/APCM/vw_equiplist.php');
		...
		$(document.body).on('keyup','input[name=EquipmentSearch]',function(){
			...
			$('#EquipmentCont table tbody').load('../../proc/views/APCM/vw_equiplist-load.php?srchval=' + encodeURI(searchVal));
		})
	...
	$('#CtrlAcctModal').on('shown.bs.modal',function()
	{
		...
		$('#CtrlAcctCont').load('../../proc/views/APCM/vw_ctrlacctlist.php',function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/APCM/vw_ctrlacctlist-load.php',
		                        data: {
									itemcode : itemcode
								},
		                        success: function(html){
	...
	$(document.body).on('keyup','input[name=CtrlAcctSearch]',function(){
        ...
        $('#CtrlAcctCont table tbody').load('../../proc/views/APCM/vw_ctrlacctlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Acct
	...
	$('#AcctModal').on('shown.bs.modal',function(){
		...
		$('#AcctCont').load('../../proc/views/APCM/vw_acctlist.php',function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/APCM/vw_acctlist-load.php',
		                        data: {
									itemcode : itemcode
								},
		                        success: function(html){
	...
	$(document.body).on('keyup','input[name=AcctSearch]',function(){
        ...
        $('#AcctCont table tbody').load('../../proc/views/APCM/vw_acctlist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Acct
	...
	$('#InvDataModal').on('shown.bs.modal',function(){
		...
		if(itemcode != ''){
			...
			$('#InvDataCont').load('../../proc/views/APCM/vw_invdatalist.php?itemcode=' + itemcode,function(){
	...
	$('#DocumentModal').on('shown.bs.modal',function(){
		...
		$('#DocumentCont').load('../../proc/views/APCM/vw_doclist.php?servicetype=' + encodeURI(servicetype),function(){
			//Add Scroll Function 
		        ...
		        if($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight){
		              if($(this).scrollTop() > 0){
		                ...
		                if(ctr == 0){
		                  ...
		                  $.ajax({
		                        type: 'POST',
		                        url: '../../proc/views/APCM/vw_doclist-load.php',
		                        data: {
									itemcode : itemcode
								},
		                        success: function(html){
	...
	$(document.body).on('keyup','input[name=DocumentSearch]',function(){
        ...
        $('#DocumentCont table tbody').load('../../proc/views/APCM/vw_doclist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search Document
	...
	$(document.body).on('keyup','input[name=txtDocEntry]',function(){
		...
		$.getJSON('../../proc/views/APCM/vw_getdocumentdata.php?docentry=' + docentry, function(data) {
	...
	$('#BPModal').on('shown.bs.modal',function(){
		...
		$('#BPCont').load('../../proc/views/APCM/vw_bplist.php?CardType=S',function(){
			//Add Scroll Function 
		        ...
		        if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/APCM/vw_bplist-load.php',
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
	...
	$(document.body).on('dblclick','#tblBP tbody > tr',function()
	{
		...
		$('textarea[name=txtShipTo]').load('../../proc/views/APCM/vw_shipto.php?cardcode=' + encodeURI(BPCode));
		
		//Load Bill To
		$('textarea[name=txtBillTo]').html('Loading...');
		$('textarea[name=txtBillTo]').load('../../proc/views/APCM/vw_billto.php?cardcode=' + encodeURI(BPCode));
	...
	$(document.body).on('keyup','input[name=BPSearch]',function(){
        ...
        $('#BPCont table tbody').load('../../proc/views/APCM/vw_bplist-load.php?srchval=' + encodeURI(searchVal));
	})
	//End Search BP
	...
	$(document.body).on('blur','input[name=txtVendorRefNo]',function()
	{
		...
		if(refno != '')
		{
			$.ajax({
				type: 'POST',
				url: '../../proc/views/APCM/vw_refno.php',
				data: 
				{
					refno : refno
				},
	...
	$(document.body).on('keyup','input[name=txtBaseEntry]',function(){
		...
		if(basentry != ''){
			//Show Base Document
			//Get PR data using JSON
			$.getJSON('../../proc/views/APCM/vw_getpodata.php?docentry=' + basentry, function(data) {
	            /* data will hold the php array as a javascript object */
                ...
                populatewithholdingPO(basentry,function()
                {
                  $('#modal-load-init').modal('hide');
                }); 
    ...
    $('#POModal').on('shown.bs.modal', function () {
        ...
        $('#POCont').load('../../proc/views/APCM/vw_podoclist.php?vendor=' + encodeURI(vendor), function () {
            //Add Scroll Function 
                ...
                if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight - 20) {
                    if ($(this).scrollTop() > 0) {
                        ...
                        if (ctr == 0) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: '../../proc/views/APCM/vw_podoclist-load.php?vendor=' + encodeURI(vendor),
                                data: {
									itemcode : itemcode
								},
                                success: function (html) {
    ...
    $(document.body).on('keyup', 'input[name=POSearch]', function () {
        ...
        $('#POCont table tbody').load('../../proc/views/APCM/vw_podoclist-load.php?srchval=' + encodeURI(searchVal) + '&vendor=' + encodeURI(vendor));
    })
    //End Search Document
	...
	$('#APCMListModal').on('shown.bs.modal',function()
	{
		$('#resView').append('<p class="text-center" id="itm-loader"><img src=../../img/ajax-loader.gif /> Loading...</p>');
	...
	$('#APCMListModal').on('hide.bs.modal',function()
	{
		$('#resView').empty();
	});
    ...
    $(document.body).on('click','#btnSaveAPV',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/APCM/exec-saveapcm.php',
                data: {
                		json : json.replace(/(\r\n|\n|\r)/gm, ''),
                		json1 : json1.replace(/(\r\n|\n|\r)/gm, ''),
                		basentry : basentry,
                ...
                success: function(html){
					...
					if(res[0] == 'true'){
						...
						disablebuttons(true)
						setTimeout(function(){
							location.replace('../../forms/APCM/APCM.php');
						},2000)
    ...
    $(document.body).on('click','#btnCancelAPV',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/APCM/exec-cancelapcm.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
    ...
    $(document.body).on('click','#btnCloseAPV',function(e){
    	...
    	if(err == 0){
    		...
    		$.ajax({
                type: 'POST',
                url: '../../proc/exec/APCM/exec-closeAPCM.php',
                data: {
                	docentry : docentry
				},
                success: function(html){
	...
	function checkitemcode(itemcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/APCM/vw_checkitemcode.php',
	        async: false,
	        data: {
				itemcode : itemcode
			},
	...
	function checkwhs(whscode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/APCM/vw_checkwhscode.php',
	        async: false,
	        data: {
				whscode : whscode
			},
	...
	function checkacctcode(acctcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/APCM/vw_checkacctcode.php',
	        async: false,
	        data: {
				acctcode : acctcode
			},
	...
	function checkbpcode(bpcode){
	  var result = '';
	   ...
	   $.ajax({
	        type: 'POST',
	        url: '../../proc/views/APCM/vw_checkbpcode.php',
	        async: false,
	        data: {
				bpcode : bpcode
			},
	...
	function populatedetPOMulti(docentry,callback) {
        ...
        $('#tblDetails tbody').load('../../proc/views/APCM/vw_podetailsdata-multi.php?docentry=' + encodeURI(docentry), function (result) {
	...
	{
		$('#tblWTAXCodeList tbody').load('../../proc/views/APCM/vw_withholdingtaxtablelist.php?docentry=' + docentry,function(result)
		{
			callback();
		});
	}

  function populatewithholdingPO(docentry,callback)
	{
		$('#tblWTAXCodeList tbody').load('../../proc/views/APCM/vw_withholdingtaxtablelist-po.php?docentry=' + docentry,function(result)
		{
			callback();
		});
	}
	...
	function populatedet(docentry,callback){
		...
		$('#tblDetails tbody').load('../../proc/views/APCM/vw_documentdetailsdata.php?docentry=' + docentry,function(result){
	...
	function populatedetPO(docentry,callback){
		...
		$('#tblDetails tbody').load('../../proc/views/APCM/vw_podetailsdata.php?docentry=' + docentry,function(result){

...
<div class="table-responsive" style="height: 350px; width:100%; border: solid lightblue 1px;">
	<table width="100%" class="table table-condensed table-hover table-bordered table-striped" id="tblAcct1">
		<thead>
			<tr>
				<th>Account No.</th>
				<th>Account Name</th>
		...
		<tbody>
	  	<?php
	  		$qry = odbc_exec($MSSQL_CONN, "USE [".$_SESSION['mssqldb']."]; SELECT TOP 20 AcctName,FormatCode,AcctCode FROM OACT WHERE Postable = 'Y'  AND frozenFor = 'N' ORDER BY FormatCode");

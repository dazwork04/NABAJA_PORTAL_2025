...
if(isset($_GET['srchval']))\
{
	...
	$itemqry = "USE [".$_SESSION['mssqldb']."]; SELECT TOP 50 T0.DocEntry,T0.DocNum,T0.Comments,T0.DocDate,T0.DocStatus, T0.Ref2
												FROM [OIGN] T0
												
												WHERE (T0.Ref2 LIKE '%$srchval%' OR T0.DocNum LIKE '%$srchval%' OR T0.Comments LIKE '%$srchval%' OR T0.DocDate LIKE '%$srchval%')

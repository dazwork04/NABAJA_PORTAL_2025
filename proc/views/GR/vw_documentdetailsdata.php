...
$qry = odbc_exec($MSSQL_CONN, " 
			SELECT T0.DocType,'N' AS LineType,T1.ItemCode,T1.Dscription,T2.InvntryUom
				...
				FROM [" . $_SESSION['mssqldb'] . "].[dbo].[OIGN] T0
				INNER JOIN [" . $_SESSION['mssqldb'] . "].[dbo].IGN1 T1
        ...
        if ($Ftext == 'N') {
            echo '
				<tr>
					...
					<td><input readonly class="form-control input-sm grosstotal numeric" value="' . $LineTotal . '"></td>

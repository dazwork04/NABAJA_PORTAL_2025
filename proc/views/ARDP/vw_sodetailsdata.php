...
$qry = odbc_exec($MSSQL_CONN, " 
        ...
        ISNULL(T9.AcctCode,'') as AcctCode,
        ISNULL(T9.FormatCode,'') as FormatCode,
        ISNULL(T9.AcctName,'') as AcctName,
        ...
        LEFT JOIN [".$_SESSION['mssqldb']."].[dbo].[OCRD] T8
				ON T0.CardCode = T8.CardCode
        LEFT JOIN [".$_SESSION['mssqldb']."].[dbo].[OACT] T9
				ON T8.DpmClear = T9.AcctCode

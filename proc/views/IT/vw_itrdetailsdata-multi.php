...
while (odbc_fetch_row($qry)):
    ...
    <tr>
        ...
        <td><input class="form-control input-sm qty required numericvalidate" value="<?php echo $Quantity; ?>"></td>
        ...
        <td class="hidden"><input readonly class="form-control input-sm docentry" value="<?php echo $DocEntry; ?>"></td>
    </tr>
    <?php
    $ctr += 1;
    ?>

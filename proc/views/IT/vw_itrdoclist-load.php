...
if(isset($_GET['srchval'])){
	...
	$itemqry = "USE [".$_SESSION['mssqldb']."]; 
            ...
            WHERE (T0.DocNum LIKE '%$srchval%' OR T0.Comments LIKE '%$srchval%' OR CONVERT(VARCHAR(10),T0.DocDate,101) LIKE '%$srchval%' OR T1.WhsName LIKE '%$srchval%' OR T0.CardName LIKE '%$srchval%')
            AND T0.DocStatus <> 'C'

...
<div class="table-responsive" style="height: 350px; width:100%; border: solid lightblue 1px;">
	<table class="table table-condensed table-hover table-bordered table-striped" id="tblWhs" width="100%">
		<thead>
			<tr>
		...
		<tbody>
	  	<?php
	  		$qry = odbc_exec($MSSQL_CONN, "USE [".$_SESSION['mssqldb']."]; SELECT WhsCode,WhsName
							FROM OWHS 
							WHERE Inactive = 'N' 
							ORDER BY WhsCode");

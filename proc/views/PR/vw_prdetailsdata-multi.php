...
$qry = odbc_exec($MSSQL_CONN, " 
			SELECT T0.DocType,'N' AS LineType,T1.ItemCode,T1.Dscription
                                ...
                                , T1.OcrCode2 AS OcrCode2, T1.unitMsr2 as unitMsr2
			...
			SELECT T0.DocType,'Y' AS LineType,'' AS ItemCode,'' AS Dscription
                        ...
                        ,'B' AS SubSeq,T1.AftLineNum, '' AS OcrCode, '' as unitMsr2
                        , '' AS OcrCode2
				FROM [" . $_SESSION['mssqldb'] . "].[dbo].OPRQ T0
        ...
        if ($Ftext == 'N') {
            echo '
				<tr>
					...
					<td><input readonly class="form-control input-sm uomname" value="' . $unitMsr2 . '"></td>

	...
	<table width="100%" class="table table-condensed table-hover table-bordered table-striped" id="tblDocument">
	  <thead>
	    <tr>
			...
			<th style="min-width:50px;">PR Doc No.</th>
			<th style="min-width:50px;">Posting Date</th>
			<th style="min-width:50px;">Requester</th>
	  ...
	  <tbody>
	  	<?php
			...
			$qry = odbc_exec($MSSQL_CONN, "USE [".$_SESSION['mssqldb']."]; SELECT TOP 30 T0.DocEntry, T0.DocNum, T0.Comments, T0.OwnerCode,
				T0.DocDate,

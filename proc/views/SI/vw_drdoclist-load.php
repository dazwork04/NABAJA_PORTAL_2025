...
if($vendor != '')
{
	if(isset($_GET['srchval']))
	{
		...
		$itemqry = "USE [".$_SESSION['mssqldb']."]; SELECT TOP 20 T0.DocEntry,T0.DocNum,T0.Comments,CONVERT(VARCHAR(10),T0.DocDate,101) AS DocDate,T0.NumAtCard,T0.DocStatus , T0.CardName, T0.CANCELED
													FROM [ODLN] T0

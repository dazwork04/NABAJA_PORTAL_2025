...
$qry = odbc_exec($MSSQL_CONN, " 
			...
			T1.LineNum AS AftLineNum
				...
				INNER JOIN [".$_SESSION['mssqldb']."].[dbo].RDR1 T1
			...
			<tr>
				...
				<td>
					<div class="input-group acctcodeCont" style="height: 18px; padding: 0 4px; margin: 0;">
						<input '.$disabled.' aria-acctcode="'.$Account.'" class="form-control input-sm acctcode required" value="'.$FormatCode.'" readonly/>
				...
				<td><input '.$disabled.' class="form-control input-sm acctname" value="'.$AcctName.'" readonly></td>

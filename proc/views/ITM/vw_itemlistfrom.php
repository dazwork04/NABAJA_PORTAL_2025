...
<div class="table-responsive" style="height: 350px; width:100%; border: solid lightblue 1px;">
	<table width="100%" class="table table-condensed table-hover table-bordered table-striped" id="tblItemFrom">
	  <thead>
	    <tr>
	      <th>Item Code</th>
	      <th>Item Name</th>
	  	...
	  	<?php
			...
			while (odbc_fetch_row($qry)) {
				echo '<tr class="srch" pageloadid="'.odbc_result($qry, 'ItemCode').'">
						...
						<td class="item-11">'.number_format(odbc_result($qry, 'Price'),2).'</td>
				      </tr>';
			}

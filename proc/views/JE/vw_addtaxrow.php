...
echo '<tr>
	...
	<td class="hidden">
		<input type="hidden" class="form-control input-sm lineno" value="1" readonly/>
		<input type="hidden" class="form-control input-sm item_index" value="'.$itemindex.'" readonly/>

...
echo '<tr>
	...
	<td style="padding-top: 2px;  padding-bottom: 2px;">
		<div class="input-group acctcodeCont">
			...
			<input type="text" class="form-control input-sm acctcode" readonly/>
			<input type="hidden" class="form-control input-sm cat" readonly/>
	...
	<td style="padding-top: 2px;  padding-bottom: 2px;">
		<input class="form-control input-sm acctname" readonly/>
	</td>
	<td style="padding-top: 2px;  padding-bottom: 2px;">
		<input class="form-control input-sm debit" readonly/>
	</td>
	<td style="padding-top: 2px;  padding-bottom: 2px;">
		<input class="form-control input-sm credit" readonly/>
	</td>
	<td style="padding-top: 2px;  padding-bottom: 2px;">
	...
	<td class="hidden">
		...
		<input type="hidden" class="form-control input-sm item_index" value="0" readonly/>
		<input type="hidden" class="form-control input-sm wtaxindex" value="1" readonly/>
	</td>
</tr>';

...
while (odbc_fetch_row($qry)) 
{
	...
	echo '
		<tr>
			...
			<td style="padding-top: 2px;  padding-bottom: 2px;">
				<input class="form-control input-sm debit" value="'.$Debit.'" readonly/>
			</td>
			<td style="padding-top: 2px;  padding-bottom: 2px;">
				<input class="form-control input-sm credit" value="'.$Credit.'" readonly/>
			</td>
			<td style="padding-top: 2px;  padding-bottom: 2px;">
				<select class="form-control input-sm taxgroup" disabled>
						<option value="">'.$VatGroup.'</option>
					</select>
				</td>
			<td style="padding-top: 2px;  padding-bottom: 2px;">
				<select class="form-control input-sm wtax" disabled>
					<option value="">'.$WTLiable.'</option>
				</select>
			</td>
			<td style="padding-top: 2px;  padding-bottom: 2px;">
				<input class="form-control input-sm linememo" value="'.$LineMemo.'" maxlength="254" readonly>
			</td>
			<td>

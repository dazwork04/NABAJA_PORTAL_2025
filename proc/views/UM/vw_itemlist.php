...
<div class="table-responsive" style="max-height:350px;overflow-y:scroll;">
	<table class="table table-condensed table-hover" id="tblItem">
	  ...
	  <tbody>
	  	<?php
	  		$qry = odbc_exec($MSSQL_CONN, "USE [".$_SESSION['mssqldb']."]; SELECT TOP 100 ItemCode, ItemName, OnHand, InvntryUom, BuyUnitMsr, ManBtchNum, NumInBuy FROM OITM WHERE validFor = 'Y' AND (PrchseItem = 'Y' OR InvntItem = 'Y') ORDER BY ItemCode,ItemName");

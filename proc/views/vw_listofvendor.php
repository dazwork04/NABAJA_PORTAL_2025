...
?>
	<table width="100%" class="table table-condensed table-hover table-bordered table-striped" id="tblListofvendor" style="font-size:10px">
		<thead>
			<tr>
		...
		<tbody>
			<?php
				$qry = odbc_exec($MSSQL_CONN, "USE [".$_SESSION['mssqldb']."]; SELECT CardCode, CardName FROM OCRD WHERE CardType = 'S' AND frozenFor = 'N' ORDER BY CardName ASC");

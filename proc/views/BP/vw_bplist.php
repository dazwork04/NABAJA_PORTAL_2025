...
<div class="table-responsive" style="height: 350px; width:100%; border: solid lightblue 1px;">
	<table width="100%" class="table table-condensed table-hover table-bordered table-striped" id="tblBP">
	  ...
	  <tbody>
	  	<?php
	  		$qry = odbc_exec($MSSQL_CONN, "USE [".$_SESSION['mssqldb']."]; SELECT TOP 20 T0.CardCode,T0.CardName,T0.Balance,T0.CntctPrsn, T0.GroupNum , T0.Currency, T0.ListNum, T0.GroupCode, T0.frozenFor, T0.CardType
																  			FROM OCRD T0 

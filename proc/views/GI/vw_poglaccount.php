<?php include_once('../../../config/config.php');
	...
	$txtPostingDate = date('Y' ,strtotime($_POST['txtPostingDate']));
	...
	$itemqry = "USE [".$_SESSION['mssqldb']."]; SELECT 
												...
												FROM OITM T0
												LEFT JOIN OGAR T1 ON T0.U_SubGrpName = T1.UDF1 AND T1.Year = '$txtPostingDate'
												LEFT JOIN OGAR T2 ON T0.ItmsGrpCod = T2.ItmsGrpCod AND T2.Year = '$txtPostingDate'
	...
	while (odbc_fetch_row($qry)) 
		{
			echo odbc_result($qry, 'InventoryAccount');

...
$qry = odbc_exec($MSSQL_CONN, " 
			...
			INNER JOIN [".$_SESSION['mssqldb']."].[dbo].IGE10 T1 ON T0.DocEntry = T1.DocEntry
            ...
            echo '
				<tr>
					...
					<td style="padding-top: 2px;  padding-bottom: 2px;" >
                        <input class="form-control input-sm itemcode required" value="' . $ItemCode . '" />
					</td>
					<td><input class="form-control input-sm itemname" value="' . $ItemName . '" /></td>
					...
					<td><input ' . $disabled . ' class="form-control input-sm price numeric numericvalidate" value=""></td>
					<td>
						<div class="input-group warehouseCont">
							<input class="form-control input-sm warehouse required" value="' . $Whse . '" />
					...
					<td>
						<div class="input-group acctcodeCont">
							<input aria-acctcode="'.$Account.'" class="form-control input-sm acctcode required" value="' . $FormatCode . '" />
					...
					<td class="hidden"><input readonly class="form-control input-sm linetotal numeric" value="' . $LineTotal . '"></td>

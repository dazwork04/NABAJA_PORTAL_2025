...
include_once('../../../config/config.php');
	...
	{
		$oSi = $vCmp->GetBusinessObject(203);
		$oSi->GetByKey($docentry);
		
		$oCancelDoc  = $vCmp->GetBusinessObject(203);
		$vDoc  = $vCmp->GetBusinessObject(203);
...
if($err == 0)
{
	echo 'true*Successfully Canceled A/R Downpayment # ' . $docentry;
}
else
{
	echo 'false*' . $errmsg;

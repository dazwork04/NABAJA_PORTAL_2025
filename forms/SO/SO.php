		...
		<div class="col-lg-12">
			<div class="panel panel-info">
				...
				<div class="panel-body">
							...
							<div class="form-group">
                				...
                				<table width="100%" border="0">
									<tbody> 
										<tr>
											<td width="5%">&nbsp;</td>
											<td width="25%">Contract Price</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input onkeypress="return isNumberKey(event)" id="txtU_ContrctPrice" type="text" name="txtU_ContrctPrice" class="form-control input-sm" maxlength="100">
											</td>
										</tr>
                    					<tr>
											<td width="5%">&nbsp;</td>
											<td width="25%">Downpaymnt</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input onkeypress="return isNumberKey(event)" id="txtU_Downpaymnt" type="text" name="txtU_Downpaymnt" class="form-control input-sm" maxlength="100">
											</td>
										</tr>
                    					<tr>
											<td width="5%">&nbsp;</td>
											<td width="25%">Miscellaneous Fee</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input onkeypress="return isNumberKey(event)" id="txtU_MiscFee" type="text" name="txtU_MiscFee" class="form-control input-sm" maxlength="100">
											</td>
										</tr>
                    					<tr>
											<td width="5%">&nbsp;</td>
											<td width="25%">Reservation Fee</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input onkeypress="return isNumberKey(event)" id="txtU_ResrvationFee" type="text" name="txtU_ResrvationFee" class="form-control input-sm" maxlength="100">
											</td>
										</tr>
									</tbody>
								</table>
								...
								<table width="100%" border="0">
									<tbody>
										...
										<tr class="hidden">
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtForwarder" type="text" name="txtForwarder" style="width:100%" class="form-control input-sm" maxlength="30">
											</td> 
											<td width="5%">&nbsp;&nbsp;&nbsp;</td>
										</tr>
										<tr class="hidden">
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<textarea rows="3" cols="40" id="txtToEmail" name="txtToEmail"></textarea>
												<button type="button" class="input-sm" data-toggle="modal" data-target="#EmailModal"><span class="fa fa-list fa-fw"></span></button>
												<span style="color:red; font-style: italic;">*Please click this button to select email. ---></span>
											</td>
											<td width="5%">&nbsp;&nbsp;&nbsp;</td>
										</tr>
									</tbody>
											...
											<tbody>
												<tr>
													...
													<td width="75%" style="padding-top: 2px;  padding-bottom: 2px;">
														<select type="text" class="form-control input-sm" id="txtPayment" name="txtPayment" disabled></select>
													</td>
												</tr>
											</tbody>	
										</table>
                    ...
                    <tr>
											<td width="5%">&nbsp;</td>
											<td width="25%">Realty</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<select type="text" class="form-control input-sm required" id="txtU_Realty" name="txtU_Realty"></select>
											</td>
										</tr>
                    <tr>
											<td width="5%">&nbsp;</td>
											<td width="25%">Sales Coordinator</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<select type="text" class="form-control input-sm required" id="txtU_SalesCoordinator" name="txtU_SalesCoordinator"></select>
											</td>
										</tr>
										<tr>
											<td width="5%">&nbsp;</td>
											<td width="25%">Sales Agent</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<select type="text" class="form-control input-sm required" id="txtSalesEmployee" name="txtSalesEmployee"></select>
											</td>
										</tr>
										<tr>
											<td width="5%">&nbsp;</td>
										...
										<tr>
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;"><textarea rows="5" cols="60" id="txtRemarksF" name="txtRemarksF" maxlength="253"></textarea>
											</td>
										</tr>
										<tr class="hidden">
											<td width="5%">&nbsp;</td>
											<td width="25%">Disapproved Remarks</td>
								...
								<table width="100%" border="0">
									<tbody>
										<tr class="hidden">
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtSerialandDONum" type="text" name="txtSerialandDONum" style="width:100%" class="form-control input-sm" maxlength="30" >
											</td>
											<td width="5%">&nbsp;&nbsp;&nbsp;</td>
										</tr>
										<tr class="hidden">
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtBuffer" type="text" name="txtBuffer" style="width:100%" class="form-control input-sm" maxlength="10" onkeypress="return isNumberKey(event)">
												<span style="color:red; font-style: italic;">*Please enter a number only.</span>
											</td>
											<td width="5%">&nbsp;&nbsp;&nbsp;</td>
										</tr>
										<tr class="hidden">
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtInternalA" type="text" name="txtInternalA" style="width:100%" class="form-control input-sm" maxlength="10" onkeypress="return isNumberKey(event)">
												<span style="color:red; font-style: italic;">*Please enter a number only.</span>
											</td>
											<td width="5%">&nbsp;&nbsp;&nbsp;</td>
										</tr>
										...
										<tr class="hidden">
											<td width="5%">&nbsp;</td>
											<td width="20%">Packing list or Invoice</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
										...
										<tr>
											...
											<td width="25%">
											 	<div class="dropdown hidden">
												  <button type="button" data-toggle="dropdown">Copy From
												  <span class="caret"></span></button>
													<ul class="dropdown-menu">
														<li><a href="#">Copy From</a></li>
													</ul>
												</div>
											</td>
											<td width="25%">
												<div class="dropdown hidden <?php echo $hidden; ?>">
					...
					<div class="col-lg-12 col-md-12">
						...
						<table width="100%" border="0">
							<tbody>
								<tr>
									<td>
										<button type="button" class="btn btn-success btn-xs dropdown-toggle" data-toggle="modal" id="btnEmail">Select<span class="fa fa-check fa-fw"></span></button>
									</td>	
								</tr>	
							</tbody>
						</table>
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnSaveSO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnCloseSO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnCancelSO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">

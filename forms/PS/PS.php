									...
									<tbody>
										<tr>
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input type="text" id="txtPrcCode" name="txtPrcCode" class="form-control input-sm required" maxlength="20">
											</td>
										</tr>
										<tr>
											<td width="5%">&nbsp;</td>
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input type="text" id="txtPrcName" name="txtPrcName" class="form-control input-sm" maxlength="100">
											</td>
										</tr>
										<tr>
											<td width="5%">&nbsp;</td>
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnSavePS" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnCancelPS" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">

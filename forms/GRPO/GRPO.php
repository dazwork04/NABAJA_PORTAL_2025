				...
				<div class="panel-heading">
					<i class="fa fa-edit fa-fw"></i> <span id="mod-title"></span>
						<div class="pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="modal" data-target="#RRListModal">RR List <span class="glyphicon glyphicon-list"></span></button>
							</div>
							<div class="btn-group">
							...
							<div class="form-group">
								<table width="100%" border="0">
									<tbody>
										...
										<!-- <tr>
											<td width="5%">&nbsp;</td>
											<td width="25%">SI/DR Ref. No.</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input type="text" id="txtRefNo" name="txtRefNo" class="form-control input-sm" maxlength="20">
											</td>
										</tr> -->
									</tbody>
								</table>
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnSaveGRPO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnCloseGRPO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnCancelGRPO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">
...
<script src="../../js/GRPO/grpo.js"></script>

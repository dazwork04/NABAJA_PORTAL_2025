				...
				<div class="panel-heading">
					<i class="fa fa-edit fa-fw"></i> <span id="mod-title"></span>
						<div class="pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="modal" data-target="#ARListModal">A/R DP List <span class="glyphicon glyphicon-list"></span></button>
							</div>
								...
								<button type="button" class="btn btn-default btn-xs" data-toggle="dropdown" id="btnPrint" disabled>Print 
									...
									<span class="caret"></span></button></button>
										<ul id="btnSelectPrint" class="dropdown-menu">
											<li><a href="#SI">A/R Downpayment Invoice</a></li>
...
<script src="../../js/ARDP/ardp.js"></script>

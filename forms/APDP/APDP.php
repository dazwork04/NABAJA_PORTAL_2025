				...
				<div class="panel-heading">
					<i class="fa fa-edit fa-fw"></i> <span id="mod-title"></span>
						<div class="pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="modal" data-target="#APDPListModal">APDP List <span class="glyphicon glyphicon-list"></span></button>
							</div>
							<div class="btn-group">
...
<!-- APDP List Modal  -->
<div class="modal fade" id="APDPListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" style="width:70%;">
		<div class="panel panel-info">
						...
						<table width="100%" border="0">
							<tbody>
								...
								<tr>
									...
									<td width="70%"  style="padding-top: 2px;  padding-bottom: 2px;">
										<input type="text" id="txtAPDPListFrom" name="txtAPDPListFrom" class="form-control input-sm"/>
									</td>
								</tr>
								<tr>
									<td width="30%">Ref. No. To : </td>
									<td width="70%"  style="padding-top: 2px;  padding-bottom: 2px;">
										<input type="text" id="txtAPDPListTo" name="txtAPDPListTo" class="form-control input-sm"/>
									</td>
								</tr>
							</tbody>
						</table>	
			...
			<div class="panel-footer">
				<div class="pull-right">
					<button type="button" id="btnAPDPListVIEW" class="btn btn-xs btn-info">VIEW <span class="fa fa-eye fa-fw"></span></button>
					<button type="button" id="btnAPDPListEXCEL" class="btn btn-xs btn-info">EXCEL <span class="fa fa-download fa-fw"></span></button>
					<button type="button" id="btnAPDPListPDF" class="btn btn-xs btn-info">PDF <span class="fa fa-file-o fa-fw"></span></button>
				</div>
...
<script src="../../js/APDP/apdp.js"></script>

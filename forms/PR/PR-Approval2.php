			...
			<div class="col-lg-12">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<table width="100%" class="table table-striped table-bordered table-hover" id="tbl_po_app1">
							<thead>
								<tr>
							...
							<tbody>
								<?php
									...
									$qry = odbc_exec($MSSQL_CONN, "USE [".$_SESSION['mssqldb']."]; 
											...
											WHERE T0.DocStatus = 'O' AND T0.U_AppStatus = 'Approved' AND T0.U_AppStatus1 = 'Pending'
					...
					<div class="panel-footer">
						<button type="button" data-toggle="dropdown" id="btnUpdateApproved1" name="btnUpdateApproved1" >&nbsp;&nbsp;&nbsp;Update <span class="fa fa-save fa-fw"></span>&nbsp;&nbsp;&nbsp;</button>
					</div>
				</div>
				<!-- /.panel -->
			</div>

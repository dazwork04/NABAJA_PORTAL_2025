    ...
    <table width="100%" border="1" id="tblDetails" bordercolor="lightblue">
        <thead>
            <tr>
			    ...
			    <th style="min-width:200px; height:30px;">&nbsp;G/L Account</th>
                <th style="min-width:200px;">&nbsp;Account Name</th>
                <th style="min-width:200px;">&nbsp;Particulars</th>
                <th style="min-width:200px;">&nbsp;Tax Group</th>
                <th style="min-width:200px;">&nbsp;Net Amount</th>
        ...
        <tbody>
           <tr>
				...
				<td style="padding-top: 2px;  padding-bottom: 2px;">
					<input onkeypress="return isNumberKey(event)" class="form-control input-sm taxamount" maxlength="13"/>
				</td>
				<td>

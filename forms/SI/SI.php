		...
		<div class="col-lg-12">
			<div class="panel panel-info">
				<div class="panel-heading">
					<i class="fa fa-edit fa-fw"></i> <span id="mod-title"></span>
						<div class="pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="modal" data-target="#ARListModal">A/R List <span class="glyphicon glyphicon-list"></span></button>
							</div>
							<div class="btn-group">
									...
									<tbody>
										...
										<tr>
											...
											<td  class="hidden" width="5%" style="padding-top: 2px;  padding-bottom: 2px;">
												<button type="button" class="input-sm" id="btnAddCustomer"><span class="fa fa-plus fa-fw"></span></button>
											</td>
										</tr>
										<tr class="hidden">
											<td width="5%">&nbsp;</td>
                ...
                <table width="100%" border="0">
                    ...
                    <tr>
											<td width="25%">Downpayment</td> 
											<td width="70%" colspan="3" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtDpmAmnt" type="text" name="txtDpmAmnt" class="form-control input-sm" style="width:100%" readonly> 
                        <input id="txtDpmAppVatBal" type="text" name="txtDpmAppVatBal" class="form-control input-sm hidden" style="width:100%" readonly> 
                        <input id="txtDpmGrossBal" type="text" name="txtDpmGrossBal" class="form-control input-sm hidden" style="width:100%" readonly>  
                        <input id="txtDPDocEntry" type="text" name="txtDPDocEntry" class="form-control input-sm hidden" style="width:100%" readonly> 
											</td>
                      <!-- <td width="5%">&nbsp;</td> -->
                      <td width="5%" style="padding-top: 2px;  padding-bottom: 2px;">
												<button id="btnDpModal" type="button" class="input-sm" data-toggle="modal" data-target="#DPModal"><span class="fa fa-list fa-fw"></span></button>
                        <!-- <span class="glyphicon glyphicon-remove"></span> -->
                        <button id="btnDpRemove" type="button" class="input-sm hidden" data-toggle="modal" data-target="#"><span class="glyphicon glyphicon-remove"></span></button>
											</td>
										</tr>
										<tr class="hidden">
											<td width="25%">Tax</td>
                    ...
                    <tr>
											<td width="25%">Tax</td>
											<td width="70%" colspan="3" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtTaxFWithDp" type="text" name="txtTaxFWithDp" class="form-control input-sm" style="width:100%" readonly>
											</td>
											<td width="5%">&nbsp;</td>
										</tr>
										<tr>
											<td width="25%">Total</td>
											<td width="70%" colspan="3" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtTotalPaymentDueWithDp" type="text" name="txtTotalPaymentDueWithDp" class="form-control input-sm" style="width:100%" readonly>
											</td>
											<td width="5%">&nbsp;</td>
										</tr>
                    <!-- END WITH DOWNPAYMENT -->
									</tbody>
								</table>
								<br>
								<table width="100%" border="0">
...
<!-- Downpayment Modal  -->
<div class="modal fade bs-example-modal-lg" id="DPModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
	<div class="modal-dialog modal-lg">
		<div class="panel panel-info">
			<div class="panel-heading">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button>
				List of Available Downpayment 
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-2">
					...
					<div class="col-lg-4">
						<input type="text" name="DPSearch" class="form-control input-sm" placeholder="Search..." />
					</div>
				</div>
				<br>
				<div class="row">

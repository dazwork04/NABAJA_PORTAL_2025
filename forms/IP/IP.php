				...
				<div class="panel-heading">
					<i class="fa fa-edit fa-fw"></i> <span id="mod-title"></span>
						<div class="pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="modal" data-target="#ReceiptListModal">Receipt List <span class="glyphicon glyphicon-list"></span></button>
							</div>
							<div class="btn-group">
							...
							<table width="100%" border="0">
								<tbody>
									...
									<tr id="trBpName">
										...
										<td class="hidden" width="5%" style="padding-top: 2px;  padding-bottom: 2px;">
											<button type="button" class="input-sm" data-toggle="modal" data-target="#BPModal"><span class="fa fa-list fa-fw"></span></button>
										</td>
									</tr>
									<tr id="trBillTo">
								...
								<table width="100%" border="0">
									<tbody>
										<tr>
											...
											<td width="90%" style="padding-top: 2px;  padding-bottom: 2px;">Customer</td>
										</tr>
										<tr>
											<td width="5%"></td>
											<td width="5%" style="padding-top: 2px;  padding-bottom: 2px;">
								...
								<table width="100%" border="0">
									<tbody>
										...
										<tr>
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtReference" type="text" name="txtReference" style="width:100%" class="form-control input-sm">
											</td>
											<td width="5%">&nbsp;</td>
										</tr>
									</tbody>
													...
													<tr>
														...
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<div class="input-group acctcodeCont">
																<input readonly class="form-control input-sm acctcode checkrequired" id="txtGLAccountCheck" name="txtGLAccountCheck" />
										...
										<div class="col-lg-12 col-md-12">
											...
											<table class="table table-hover table-bordered table-condensed" id="tblChecks">
												...
												<tbody>
													...
													<td><input type="text" class="form-control input-sm" id="txtCheckAccount" name="txtCheckAccount" readonly></td>
													<td><input type="text" class="form-control input-sm checkrequired" onkeypress="return isNumberKey(event)"  id="txtCheckNo" name="txtCheckNo" maxlength="10"></td>
													
													<td><input type="text" class="form-control input-sm numeric" onkeypress="return isNumberKey(event)"  id="txtCheckAmount" name="txtCheckAmount"></td>
											...
											<table width="100%" border="0">
												<tbody>
													<tr>
														...
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<div class="input-group acctcodeCont">
																<input readonly class="form-control input-sm acctcode bankrequired" id="txtGLAccountBankTransfer" name="txtGLAccountBankTransfer" />
																<span class="input-group-addon" style="height: 18px; padding: 0 4px; margin: 0;" data-toggle="modal" data-target="#AcctModal"><span class="glyphicon glyphicon-list"></span></span>
															</div>
														</td>
													</tr>
													...
													<tr>
														...
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<input type="text" class="form-control input-sm" id="txtBankTransferReference" name="txtBankTransferReference">
														</td>
													</tr>
													<tr>
											...
											<table width="100%" border="0">
												<tbody>
													<tr>
														...
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<div class="input-group acctcodeCont">
																<input readonly class="form-control input-sm acctcode cashrequired" id="txtGLAccountCash" name="txtGLAccountCash" />
																<span class="input-group-addon" style="height: 18px; padding: 0 4px; margin: 0;" data-toggle="modal" data-target="#AcctModal"><span class="glyphicon glyphicon-list"></span></span>
															</div>
														</td>
													</tr>
												...
												<tbody>
													<tr>
														...
														<td width="40%" style="padding-top: 2px;  padding-bottom: 2px;">
															<select class="form-control input-sm creditcardrequired" id="selCreditCardName" name="selCreditCardName">
													...
													<tr>
														<td width="30%">GL Account</td>
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<input class="form-control input-sm creditcardrequired" id="txtGLAccountCreditCard" name="txtGLAccountCreditCard" />
														</td>
													</tr>
													<tr>
														<td width="30%">Amount Due</td>
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<input type="text" onkeypress="return isNumberKey(event)" class="form-control input-sm numeric creditcardrequired" id="txtAmountDue" name="txtAmountDue" />
														</td>
													</tr>
													<tr>
														<td width="30%">Credit Card No.</td>
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<input class="form-control input-sm creditcardrequired" id="txtCreditCardNo" name="txtCreditCardNo" maxlength="4" value="0001" readonly />
														</td>
													</tr>
													<tr>
														<td width="30%">Valid Until</td>
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<input class="form-control input-sm creditcardrequired" id="txtValidUntil" name="txtValidUntil" value="<?php echo  date("m/d/Y"); ?>" readonly/>
														</td>
													</tr>
													...
													<tr>
														...
														<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
															<input class="form-control input-sm" id="txtVoucherNo" name="txtVoucherNo" maxlength="20" value="1" readonly/>
														</td>
													</tr>
													<tr>
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnSaveIP" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnCancelIP" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">
...
<!-- IP List Modal  -->
<div class="modal fade" id="ReceiptListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" style="width:70%;">
		<div class="panel panel-info">
			<div class="panel-heading">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button>
				Receipt List Parameter 
			</div>
			<div class="panel-body">
				<div class="row">
					<div class="col-lg-3">
						<table width="100%" border="0">
							<tbody>
								...
								<tr>
									...
									<td width="70%"  style="padding-top: 2px;  padding-bottom: 2px;">
										<input type="text" id="txtReceiptListFrom" name="txtReceiptListFrom" class="form-control input-sm"/>
									</td>
								</tr>
								<tr>
									<td width="30%">Ref. No. To : </td>
									<td width="70%"  style="padding-top: 2px;  padding-bottom: 2px;">
										<input type="text" id="txtReceiptListTo" name="txtReceiptListTo" class="form-control input-sm"/>
									</td>
								</tr>
							</tbody>
						</table>	
			...
			<div class="panel-footer">
				<div class="pull-right">
					<button type="button" id="btnReceiptListVIEW" class="btn btn-xs btn-info">VIEW <span class="fa fa-eye fa-fw"></span></button>
					<button type="button" id="btnReceiptListEXCEL" class="btn btn-xs btn-info">EXCEL <span class="fa fa-download fa-fw"></span></button>
					<button type="button" id="btnReceiptListPDF" class="btn btn-xs btn-info">PDF <span class="fa fa-file-o fa-fw"></span></button>
				</div>

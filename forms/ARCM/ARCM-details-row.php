...
?>
		<tr>
			...
			<td><input onkeypress="return isNumberKey(event)" class="form-control input-sm qty required numericvalidate" maxlength="11">
			...
			<td>
				<input  onkeypress="return isNumberKey(event)" class="form-control input-sm price required numeric numericvalidate" maxlength="11">
			...
			<td>
				<div class="input-group warehouseCont" style="height: 18px; padding: 0 4px; margin: 0;">
					<input class="form-control input-sm warehouse required" readonly/>
			...
			<td class="hidden">
				<div class="input-group departmentCont hidden" style="height: 18px; padding: 0 4px; margin: 0;">
...
<!--Service Type-->
	<tr>
		<td style="padding-top: 2px;  padding-bottom: 2px;"  class="rowno text-center"></td>
		<td style="padding-top: 2px;  padding-bottom: 2px;" ><textarea class="form-control input-sm remarks required"></textarea></td>
		<td>
		...
		<td><input readonly class="form-control input-sm lineno" type="hidden"></td>	
	</tr>
<!--End Service Type-->
<?php } ?>
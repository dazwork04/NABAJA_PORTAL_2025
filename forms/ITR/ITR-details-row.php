...
if ($servicetype == 'I') {
    if (!isset($_GET['freetext'])) {
        ...
        <tr>
            ...
            <td style="padding-top: 2px;  padding-bottom: 2px;"><input class="form-control input-sm itemname" /></td>
            <td style="padding-top: 2px;  padding-bottom: 2px;" class="">
                <div class="input-group warehouseCont">
                    <input class="form-control input-sm linefromwarehouse required" name="txtLineFromWarehouse" />
            ...
            <td style="padding-top: 2px;  padding-bottom: 2px;" class="">
                <div class="input-group warehouseCont">
                    <input class="form-control input-sm linetowarehouse required"  name="txtLineToWarehouse"  />
                    <span class="input-group-addon" style="height: 18px; padding: 0 4px; margin: 0;" data-toggle="modal" data-target="#WhsModal"><span class="glyphicon glyphicon-list"></span></span>
                </div>
            </td>
            ...
            <td style="padding-top: 2px;  padding-bottom: 2px;"><input class="form-control input-sm qty required numericvalidate">
            ...
            <td style="padding-top: 2px;  padding-bottom: 2px;" class="hidden"><select class="form-control input-sm taxcode"><?php echo $taxcode ?></select></td>
            ...
            <td style="padding-top: 2px;  padding-bottom: 2px;" class="hidden"><input readonly class="form-control input-sm lineno"></td>

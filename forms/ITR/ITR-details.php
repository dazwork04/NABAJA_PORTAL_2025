<table width="100%" border="1" id="tblDetails" bordercolor="lightblue">
	<thead>
		<tr>
			...
			<th style="min-width:70px;">&nbsp;From Warehouse</th>
			<th style="min-width:70px;">&nbsp;To Warehouse</th>
			<th style="min-width:90px;" class="hidden">Bar Code</th>
			...
			<th style="min-width:200px;" class="hidden">Unit Price</th>
			<th style="min-width:200px;" class="hidden">Warehouse</th>
			...
			<th style="min-width:200px;" class="hidden">Total (LC)</th>

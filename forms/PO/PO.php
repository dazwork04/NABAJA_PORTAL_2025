...
$DocEntryApp = !isset($_GET['DocEntryApp'])? '' : $_GET['DocEntryApp'];

$empid = $_SESSION['SESS_EMP'];
$name = $_SESSION['SESS_NAME'];

// CR Session
$SERVER_NAME = $_SESSION['mssqlserver'];
$SERVER_IP = $_SESSION['SERVER_IP'];
$CR_PORT = $_SESSION['CR_PORT'];
$CR_PATH = $_SESSION['CR_PATH'];


$datetoday = date('mm/dd/Y');
...
?>
  <!-- CR Details --> 
  <input readonly="" type="hidden" class="form-control input-sm" id="SERVER_NAME" name="SERVER_NAME" value="<?php echo $SERVER_NAME?>">
  <input readonly="" type="hidden" class="form-control input-sm" id="SERVER_IP" name="SERVER_IP" value="<?php echo $SERVER_IP?>">
  <input readonly="" type="hidden" class="form-control input-sm" id="CR_PORT" name="CR_PORT" value="<?php echo $CR_PORT?>">
  <input readonly="" type="hidden" class="form-control input-sm" id="CR_PATH" name="CR_PATH" value="<?php echo $CR_PATH?>">
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<i class="fa fa-edit fa-fw"></i> <span id="mod-title"></span>
						<div class="pull-right">
							<div class="btn-group">
								<button type="button" class="btn btn-default btn-xs dropdown-toggle" data-toggle="modal" data-target="#POListModal">PO List <span class="glyphicon glyphicon-list"></span></button>
							</div>
							<div class="btn-group">
                ...
                <div class="dropdown">
                    ...
                    <ul id="btnSelectPrint" class="dropdown-menu">
											<li><a href="#PO1">NLC_Purchase_Order_BDOD</a></li>
											<li><a href="#PO2">NLC_Purchase_Order</a></li>
										</ul>  
								</div>
								<!-- <button type="button" class="btn btn-default btn-xs dropdown-toggle" id="btnPrint" disabled>Print <span class="glyphicon glyphicon-print"></span>
                  <span class="caret"></span></button> 
										<ul id="btnSelectPrint" class="dropdown-menu">
											<li><a href="#PO1">NLC_Purchase_Order_BDOD</a></li>
											<li><a href="#PO2">NLC_Purchase_Order</a></li>
									...
									<tbody>
										<tr>
											...
											<td width="70%"  style="padding-top: 2px;  padding-bottom: 2px;">
												...
												<input readonly="" type="hidden" class="form-control input-sm" id="txtDocEntry" name="txtDocEntry" value="">
												<input readonly="" type="hidden" class="form-control input-sm" id="txtDocEntryApp" name="txtDocEntryApp" value="<?php echo $DocEntryApp?>">
												<input readonly="" type="hidden" class="form-control input-sm" id="txtBaseEntry" name="txtBaseEntry" value="<?php echo $BaseEntry?>">
												<input id="txtVendor" type="text" name="txtVendor" class="form-control input-sm required" maxlength="15">
											</td>
										...
										<tr class="hidden">
											<td width="5%">&nbsp;</td>
											<td width="25%">PO Ref.</td>
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtDocRef" type="text" name="txtDocRef" class="form-control input-sm" maxlength="50">
											</td>
										</tr>
										<tr class="hidden">
											<td width="5%">&nbsp;</td>
											...
											<td width="70%" style="padding-top: 2px;  padding-bottom: 2px;">
												<input id="txtPRRef" type="text" name="txtPRRef" class="form-control input-sm" maxlength="50" readonly>
											</td>
										</tr>
										<tr class="hidden">
											<td width="5%">&nbsp;</td>
											 	...
											 	<div class="dropdown">
												  ...
												  <span class="caret"></span></button>
													<ul id="btnCopyFrom" class="dropdown-menu">
														<li><a href="#PR">Purchase Request</a></li>
													</ul>
												</div>
											</td>
											<td width="25%">
												<div class="dropdown hidden">
												  ...
												  <span class="caret"></span></button>
													<ul id="btnCopy" class="dropdown-menu">
														<li><a href="#GRPO">Receiving (GRPO)</a></li>
													</ul>
												</div>
											</td>
											<td width="25%">
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-lg-4">
							<input type="text" name="PRSearch" class="form-control input-sm" placeholder="Search..." />
						</div>
					</div>
					<br>
					<div class="row">
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnSavePO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnClosePO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">
		...
		<div class="col-xs-12">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					...
					<div class="pull-right">
						<button type="button" id="btnCancelPO" class="form-control btn btn-success" data-dismiss="modal">Yes</button>
					</div>
				</div>
				<div class="panel-footer">
...
<!-- PO List Modal  -->
<div class="modal fade" id="POListModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" style="width:70%;">
		<div class="panel panel-info">
			...
			<div class="panel-footer">
				<div class="pull-right">
					<button type="button" id="btnPOListVIEW" class="btn btn-xs btn-info">VIEW <span class="fa fa-eye fa-fw"></span></button>
					<button type="button" id="btnPOListEXCEL" class="btn btn-xs btn-info">EXCEL <span class="fa fa-download fa-fw"></span></button>
					<button type="button" id="btnPOListPDF" class="btn btn-xs btn-info">PDF <span class="fa fa-file-o fa-fw"></span></button>
				</div>

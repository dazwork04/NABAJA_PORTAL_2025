...
$htmlheader .= '<table width="100%" border="0">
					<thead>
						...
						<tr>
							<td  width="100%" align="center" valign="center"><span style="font-size: 12pt; color:black;"><b>Purchase Order List</b></span><br></td>
						</tr>
						<tr>
            ...
            <div class="col-lg-12">
				<table width="100%" border="0">
					<thead>
						...
						<tr>
							<td>Total Unserved : <b>'.number_format($TotalUnserved,2).'</b></td>
						</tr>
					</thead>
				</table>
				<table width="100%" border="0">
					<thead>
						<tr>
							<th style="border-top:1px solid black; border-bottom:1px solid black;" align="left">P.O. Date</th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;" align="left">Vendor Name</th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>P.O. Ref. No.</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>P.O. Remarks</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>P.O. Total</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>P.O. Status</center></th>
						</tr>
					</thead>
					<tbody >
						'.$htmldetails.'

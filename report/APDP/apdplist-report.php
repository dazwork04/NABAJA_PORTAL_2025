...
$htmlheader .= '<table width="100%" border="0">
					<thead>
						...
						<tr>
							<td  width="100%" align="center" valign="center"><span style="font-size: 12pt; color:black;"><b>AP Down Payment List</b></span><br></td>
						</tr>
						<tr>
		...
		<div class="row">
            <div class="col-lg-12">
				<table width="100%" border="0">
					<thead>
						<tr>
							<th style="border-top:1px solid black; border-bottom:1px solid black;" align="left">A.P.D.P. Date</th>
							...
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>A.P.D.P. Ref. No.</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>Cust. Inv. No.</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>Net Due</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>A.P.D.P. Total</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>A.P.D.P. Status</center></th>
						</tr>
					</thead>
					<tbody >
						'.$htmldetails.'

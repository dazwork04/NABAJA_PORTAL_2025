...
while (odbc_fetch_row($qry)) 
{
	$htmldetails .= '<tr>
									...
									<td class="item-3" style="padding: 1px; ">'.odbc_result($qry, 'FromWhsname').'</td>
									<td class="item-3" style="padding: 1px; ">'.odbc_result($qry, 'WhsName').'</td>
...
$htmlheader .= '<table width="100%" border="0">
								<thead>
									...
									<tr>
										<td  width="100%" align="center" valign="center"><span style="font-size: 12pt; color:black;"><b>Transfer Request List</b></span><br></td>
									</tr>
									<tr>
		...
		<div class="row">
            <div class="col-lg-12">
				<table width="100%" border="0">
					<thead>
						<tr>
							<th style="border-top:1px solid black; border-bottom:1px solid black;" align="left">I.T.R. Doc No.</th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;" align="left">Date</th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>From Whse</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>To Whse</center></th>

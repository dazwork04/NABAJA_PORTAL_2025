				...
				<table width="100%" border="1">
					<tbody>
						<tr>
							<td width="8%"></td>
							<td width="66%"><b></b></td>
							<td width="17%" align="left"><b>'.$CheckDate.'</b></td>
						</tr>
						<tr>
							<td width="8%"></td>
							<td width="58%"  style="padding-top:10px; padding-bottom:10px;"><b>'.$VendorName.'</b></td>
							<td width="17%" align="left"><b>'.number_format($CheckSum,2).'</b></td>
						</tr>
						<tr>
			
							<td width="58%" colspan="3"><b><span style="font-size:9pt;">**'.strtoupper(numberTowords($CheckSum)).'</span></b></td>

...
$NumAtCard1 = $_GET['txtAPVFrom'];
$NumAtCard2 = $_GET['txtAPVTo'];
...
$qry = odbc_exec($MSSQL_CONN, " 
		...
		WHERE C.CANCELED = 'N' AND C.NumAtCard BETWEEN '".$NumAtCard1."' AND '".$NumAtCard2."'  
            ...
            <div class="col-lg-12">
				...
				<table width="100%" border="0">
					<tbody style="padding:5px!important">
						<tr>
							<td><b>From : '.$NumAtCard1.' to '.$NumAtCard2.'</b></td>
						</tr>
					</tbody>
				</table>
				<table border="0" style="table-layout: fixed; white-space: normal!important; width:700px;">
					...
					<tbody>
						...
						<tr>
						   ...
						   <td width="100px" style="border-bottom:2px solid black; border-top:2px solid black;" align="right"><b>'.number_format($GrandTotalQuantity,2).'</b></td>

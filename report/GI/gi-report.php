...
while (odbc_fetch_row($qry)) 
{
	...
	$DocDate = date('F d, Y' ,strtotime(odbc_result($qry, 'DocDate')));
	$Ref2 = utf8_encode(odbc_result($qry, 'Ref2'));
            ...
            <div class="col-lg-12">
				<table width="100%" border="0">
					<thead>
						...
						<tr>
							<td>&nbsp;</td>
							<td align="right"><b><h2>GOODS ISSUE</h2></b></td>
						</tr>
					</thead>
				</table>
				<br>
				<table width="100%" border="0" style="font-size:8pt;">
					<tbody>
						<tr>
							<td width="50%">Ref. No. : <b>'.$Ref2.'</b></td>
							<td width="50%" align="right">Date : <b>'.$DocDate.'</b></td>
						</tr>
					</tbody>
				</table>
				<br>

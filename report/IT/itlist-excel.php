...
$qry = odbc_exec($MSSQL_CONN, " 
		...
		$TitleHeader = ""."\t"."\t"."\t"."Inventory Transfer LIST"."\t";
		$DateHeader = ""."\t"."\t"."\t".$DateRange."\t".""."\t"."\t"."Date Printed: ".date("m/d/Y h:i A")."\t";
								
		$columnHeader = "I.T. Doc No."."\t".
						"Date"."\t".
						"From Whse"."\t".
						"To Whse"."\t".
						"Remarks"."\t";
		...
		while (odbc_fetch_row($qry)) 
			{
				$setData .= trim(utf8_encode(odbc_result($qry, 'DocNum')))."\t".
									...
									trim(utf8_encode(odbc_result($qry, 'FromWhsname')))."\t".
									trim(utf8_encode(odbc_result($qry, 'WhsName')))."\t".
...
header("Content-Disposition: attachment; filename=Inventory Transfer List_".$date.".xls");

...
$htmlheader .= '<table width="100%" border="0">
								<thead>
									...
									<tr>
										<td  width="100%" align="center" valign="center"><span style="font-size: 12pt; color:black;"><b>Inventory Transfer List</b></span><br></td>
									</tr>
									<tr>
		...
		<div class="row">
            <div class="col-lg-12">
				<table width="100%" border="0">
					<thead>
						<tr>
							<th style="border-top:1px solid black; border-bottom:1px solid black;" align="left">I.T. Doc No.</th>

...
while (odbc_fetch_row($qry)) 
{
	...
	if($VatGroup == 'OVAT-N' || $VatGroup == 'OVAT-S')
	{
            ...
            <div class="col-lg-12">
				<table width="100%" border="0">
					<thead>
						...
						<tr>
							<td>&nbsp;</td>
							<td align="right"><b><h2>CHARGE INVOICE</h2></b></td>
						</tr>
					</thead>
				</table>
				<br>
				...
				<table width="100%" border="0">
					<tbody>
						<tr>
							<td width="29%" valign="top"><center><b>___________________________</b></center></td>
							<td width="29%" valign="top"><center><b>___________________________</b></center></td>
							<td width="29%" valign="top"><center><b>___________________________</b></center></td>
							<td width="13%" valign="top"><center><b>___________________________</b></center></td>
						</tr>
						<tr>
							<td width="29%" valign="top"><center><b>PRINT NAME</b></center></td>
							<td width="29%" valign="top"><center><b>SIGNATURE</b></center></td>
							<td width="29%" valign="top"><center><b>POSITION</b></center></td>
							<td width="13%" valign="top"><center><b>DATE</b></center></td>
						</tr>
					</tbody>
				</table>
				<br>
				<table width="100%" border="0" style="font-family:Tahoma, Tahoma, Tahoma;">
					<tr>
						<td width="30%" style="font-family:Tahoma, Tahoma, Tahoma; font-size:7pt;" colspan="3"><center><b>"THIS CHARGE INVOICE SHALL BE VALID FOR FIVE (5) YEARS FROM THE DATE OF ATP"</b></center></td>
					</tr>
					<tr>
					...
					<tr>
						<td width="30%" style="font-family:Tahoma, Tahoma, Tahoma; font-size:6pt;"><b>Series :</b>  CI0000000001 to CI9999999999</td>

...
$qry = odbc_exec($MSSQL_CONN, " 
		...
		$DateRange = $txtARListFrom . ' to ' .$txtARListTo;
		
		$TitleHeader = ""."\t"."\t"."\t"."A/R Credit Memo LIST"."\t";
		$DateHeader = ""."\t"."\t"."\t".$DateRange."\t".""."\t"."\t"."Date Printed: ".date("m/d/Y h:i A")."\t";
								
		$columnHeader = "A.R. Date"."\t".
						"Customer Code"."\t".
						"Customer Name"."\t".
						"A.R. Ref. No."."\t".
						"Remarks"."\t".
...
header("Content-Disposition: attachment; filename=A/R Invoice List_".$date.".xls");

...
while (odbc_fetch_row($qry)) 
{
	...
	$htmldetails .= '<tr>
									   <td width="20%" style="padding: 1px; ">'.$AcctName.'</td>
...
$htmlheader .= '<table width="100%" border="0">
					<thead>
						...
						<tr>
							<td  width="100%" align="center" valign="center"><span style="font-size: 12pt; color:black;"><b>General Journal</b></span><br></td>
						</tr>
					</thead>
				</table>
				<table width="100%" border="0">
					<thead>
						<tr>
							<td>DATE : <b>'.$RefDate.'</b></td>
						</tr>
						<tr>
							<td>REF. NO : <b>'.$Ref1.'</b></td>
						</tr>
					</thead>
				</table>';
$html .= '
		<div class="row">
            <div class="col-lg-12">
				...
				<table width="100%" border="0">
					<thead>
						<tr>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>ACCOUNT DESCRIPTION</center></th>
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>TRANSACTION DESCRIPTION</center></th>
							...
							<th style="border-top:1px solid black; border-bottom:1px solid black;"><center>CODE</center></th>
						</tr>
					</thead>
					<tbody >
						'.$htmldetails.'

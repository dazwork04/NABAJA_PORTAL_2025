...
{
	$htmldetails .= '<tr>
						<td class="item-2" style="padding: 1px;">'.odbc_result($qry, 'Ref1').'</td>
						<td class="item-4" style="padding: 1px;">'.date('m/d/Y' ,strtotime(odbc_result($qry, 'RefDate'))).'</td>
						<td class="item-3" style="padding: 1px;" align="right">'.number_format(odbc_result($qry, 'LocTotal'),2).'</td>
						<td class="item-3" style="padding: 1px;" align="right">'.number_format(odbc_result($qry, 'LocTotal'),2).'</td>
						<td class="item-3" style="padding: 1px;">&nbsp;&nbsp;&nbsp;&nbsp;'.odbc_result($qry, 'Memo').'</td>
					</tr>';
...
$htmlheader .= '<table width="100%" border="0">
					<thead>
						...
						<tr>
							<td  width="100%" align="center" valign="center"><span style="font-size: 12pt; color:black;"><b>Journal Entry List</b></span><br></td>
						</tr>
						<tr>
		...
		<div class="row">
            <div class="col-lg-12">
				<table width="100%" border="0">
					<thead>
						<tr>
							<th width="15%" style="border-top:1px solid black; border-bottom:1px solid black;" align="left">Ref. No.</th>
							<th width="15%" style="border-top:1px solid black; border-bottom:1px solid black;" align="left">Date</th>
							<th width="15%" style="border-top:1px solid black; border-bottom:1px solid black;">Debit</th>
							<th width="15%" style="border-top:1px solid black; border-bottom:1px solid black;">Credit</th>
							<th width="50%" style="border-top:1px solid black; border-bottom:1px solid black;">Remarks</th>
						</tr>
					</thead>
					<tbody >
						'.$htmldetails.'

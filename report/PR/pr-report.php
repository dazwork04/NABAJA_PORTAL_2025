...
while (odbc_fetch_row($qry)) 
{
	...
	$CardCode = odbc_result($qry, 'Requester');
	$CardName = odbc_result($qry, 'RequesterName');
	$Address = utf8_decode(odbc_result($qry, 'Address2'));
	$LicTradNum = odbc_result($qry, 'LicTradNum');
	$NumAtCard = odbc_result($qry, 'NumAtCard');
	$DocDate = date('m/d/Y' ,strtotime(odbc_result($qry, 'ReqDate')));
	...
	$htmldetails .= '<tr>
                        ...
                        <td width="20%" style="padding: 2px;border:1px solid black">'.utf8_encode(odbc_result($qry, 'Dscription')).'</td>
            ...
            <div class="col-lg-12">
				<table width="100%" border="0">
					<thead>
						...
						<tr>
							<td>&nbsp;</td>
							<td align="right"><b><h2>PURCHASE REQUEST</h2></b></td>
						</tr>
					</thead>
				</table>
				<br>
